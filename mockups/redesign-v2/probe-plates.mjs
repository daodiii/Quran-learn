...
await p.goto('file:///Users/daodilyas/quran-learn/mockups/redesign-v2/landing-plates.html', { waitUntil: 'networkidle' });
...
const state = await p.evaluate(() => ({
  horiz: document.documentElement.classList.contains('horiz'),
