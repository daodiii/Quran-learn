...
- [Trilateral Roots (Three Letters)](#trilateral-roots)
- [Quadrilateral Roots (Four Letters)](#quadrilateral-roots)
- [Common Derivation Patterns](#derivation-patterns)
- [How to Look Up a Quranic Word](#dictionary-lookup)
- [Common Quranic Root Families](#root-families)
- [Practical Application](#practical-application)
- [Next Steps in Your Journey](#next-steps)

---

<h2 id="what-are-roots">What Are Roots?</h2>
...
<h2 id="trilateral-roots">Trilateral Roots (Three Letters)</h2>
...
<h2 id="quadrilateral-roots">Quadrilateral Roots (Four Letters)</h2>
...
<h2 id="derivation-patterns">Common Derivation Patterns</h2>
...
<h2 id="dictionary-lookup">How to Look Up a Quranic Word in a Dictionary</h2>
...
<h2 id="root-families">Common Quranic Root Families</h2>
...
<h2 id="next-steps">Next Steps in Your Journey</h2>
