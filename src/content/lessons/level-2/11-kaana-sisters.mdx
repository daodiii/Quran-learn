...
**Connection to previous learning:** In [L2.10](/learn/level-2/inna-sisters), إِنَّ modified the subject while leaving the predicate nominative. Now كَانَ does the reverse: it keeps the subject nominative but changes the predicate to accusative. Together, these two families complete your understanding of how Arabic systematically modifies nominal sentences.
...
**Why inverted?**
1. **Emphasis:** Placing البر (righteousness) first emphasizes WHAT is being negated
...
**Key insight:** Case markers (accusative البر vs. nominative verbal clause) identify grammatical function regardless of word order. Arabic's flexible word order allows emphasis and style variation while maintaining grammatical clarity through case endings.
...
**Previous lessons:**
- [The Nominal Sentence](/learn/level-2/nominal-sentence) — Foundation of jumlah ismiyyah
...
- [Inna and Her Sisters](/learn/level-2/inna-sisters) — Particles that put subjects in accusative (mirror of kaana)

**Sister concept:**
Kaana sisters (predicate → accusative) are the perfect complement to [inna sisters](/learn/level-2/inna-sisters) (subject → accusative). Together they show Arabic's systematic approach to modifying nominal sentences.
...
- [Verb Conjugation Tables](/resources/verb-tables) — Kaana conjugations across all persons/tenses
