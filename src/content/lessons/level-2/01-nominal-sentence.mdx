...
**Connection to previous learning:** In [L1.10 Simple Sentences](/learn/level-1/simple-sentences), you learned to identify nominal sentences by their first word. In [L1.11 Case Endings](/learn/level-1/case-endings), you discovered that both parts take nominative case. Now we'll explore WHY this structure works and how to analyze it with precision.
...
For now, we'll focus on the first two types. Complex predicates will be covered in [L2.02](/learn/level-2/subject-predicate).
...
**Advanced note:** The verb كَانَ (kāna) "was/is" is special — when it enters a nominal sentence, the subject stays nominative but the predicate shifts to accusative. You'll study this in detail in [L2.11 Kaana and Sisters](/learn/level-2/kaana-sisters).
...
**Related lessons:**
- [L1.10: Simple Sentences](/learn/level-1/simple-sentences) — Basic sentence type identification
- [L1.11: Case Endings](/learn/level-1/case-endings) — Introduction to the three cases
- [L2.02: Subject & Predicate](/learn/level-2/subject-predicate) — Detailed analysis of mubtadaʾ and khabar
- [L2.04: Nominative Case](/learn/level-2/nominative-case) — Complete study of when rafʿ applies

</Callout>

<Callout type="warning" title="Common Mistakes">

**Don't assume word order is completely flexible.** While Arabic allows the predicate to come before the subject (especially with prepositional phrases), changing word order changes EMPHASIS and sometimes meaning. The standard, unmarked order is: Subject → Predicate. Inversion creates special rhetorical effects (see [L5.14: Word Order & Emphasis](/learn/level-5/word-order)).
...
**Prerequisites:**
- [L1.10: Introduction to Simple Sentences](/learn/level-1/simple-sentences) — Basic sentence type recognition
- [L1.11: Introduction to Case Endings](/learn/level-1/case-endings) — Understanding the three cases

**Build on this lesson:**
- [L2.02: Subject & Predicate (Mubtada & Khabar)](/learn/level-2/subject-predicate) — Advanced analysis of nominal sentence components
- [L2.03: The Verbal Sentence](/learn/level-2/verbal-sentence) — Contrasting structure with nominal sentences
- [L2.10: Inna and Sisters](/learn/level-2/inna-sisters) — Particles that modify nominal sentences
- [L2.11: Kaana and Sisters](/learn/level-2/kaana-sisters) — Verbs that affect nominal sentence structure
