...
**Connection to previous learning:** In [L1.09 Simple Sentences](/learn/level-1/09-simple-sentences/), you learned to identify nominal sentences by their first word. In [L1.10 Case Endings](/learn/level-1/10-case-endings/), you discovered that both parts take nominative case. Now we'll explore WHY this structure works and how to analyze it with precision.
...
The Quran begins with nominal sentences: ٱللَّهُ ٱلصَّمَدُ, ذَٰلِكَ ٱلْكِتَابُ. Understanding nominal sentences means you can parse the most common sentence type in the Quran — declarations of truth, descriptions of Allah, and statements of belief.
</Callout>

<Callout type="note" title="Quick Win">
ٱللَّهُ أَكْبَرُ is a nominal sentence you say in every prayer. Subject: ٱللَّهُ. Predicate: أَكْبَرُ. You now understand its grammatical structure.
</Callout>
...
- **Nominal sentence** (jumla ismiyya / جُمْلَة اِسْمِيَّة) — a "noun sentence": it starts with a noun and needs no verb (e.g. "The book [is] new").
- **Mubtadaʾ** (مُبْتَدَأ) — the starting word: the thing the sentence is about (the subject).
- **Khabar** (خَبَر) — the "news": what you say about the mubtadaʾ (the predicate).
- **Nominative** (rafʿ / رَفْع) — the "doer/topic" ending, usually a damma (-u); both parts of a nominal sentence take it.
</Callout>
...
**Related lessons:**
- [L1.09: Simple Sentences](/learn/level-1/09-simple-sentences/) — Basic sentence type identification
- [L1.10: Case Endings](/learn/level-1/10-case-endings/) — Introduction to the three cases
...
<ExerciseBox question="Exercise 5 — Verse Discovery: Read this verse you haven't seen above and identify the mubtada' and khabar: وَٱللَّهُ غَفُورٌ رَّحِيمٌ (wa-llāhu ghafūrun raḥīmun) — 'And Allah is Forgiving, Merciful' [Al-Baqarah 2:218]">
...
<ExerciseBox question="Exercise 6 — Mini I'rab: Parse every word in this phrase: وَٱلْأَرْضُ قَبْضَتُهُۥ (wa-l-arḍu qabḍatuhū) — 'And the earth is His grip' [Az-Zumar 39:67]. State the sentence type, identify the subject and predicate, and note each case marker.">
...
**Grammar checklist:**
1. Sentence type — Nominal (begins with a noun)
2. Both parts nominative — damma on ٱلْأَرْضُ and on قَبْضَةُ
3. Khabar type — Single noun phrase (possessive construction)

</ExerciseBox>

<ExerciseBox question="Exercise 7 — Synthesis: Compare these two phrases and explain how the definite article (ال) and gender agreement interact with the nominal sentence structure: (a) ٱلسَّمَاءُ عَالِيَةٌ (as-samāʾu ʿāliyatun) — 'The sky is high' and (b) ٱلْبَحْرُ عَمِيقٌ (al-baḥru ʿamīqun) — 'The sea is deep'">
...
1. **Definite article (ال):** Present on both subjects but absent from both predicates. Recall from [L1.03](/learn/level-1/03-definite-article/): a definite noun + indefinite adjective forms a nominal sentence ("The sky is high"), while a definite noun + definite adjective forms a descriptive phrase ("the high sky").
2. **Gender agreement:** The predicate adjective must match the gender of the subject — عَالِيَةٌ (feminine) for ٱلسَّمَاءُ (feminine) and عَمِيقٌ (masculine) for ٱلْبَحْرُ (masculine). This connects to [L1.04](/learn/level-1/04-gender/).
3. **Case:** Both subjects and predicates carry nominative markers, confirming the nominal sentence rule you learned in this lesson.
...
**Prerequisites:**
- [L1.09: Introduction to Simple Sentences](/learn/level-1/09-simple-sentences/) — Basic sentence type recognition
- [L1.10: Introduction to Case Endings](/learn/level-1/10-case-endings/) — Understanding the three cases
