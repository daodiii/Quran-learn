...
1. **Definite article (ال):** Present on both subjects but absent from both predicates. Recall from [L1.06](/learn/level-1/06-definite-article/): a definite noun + indefinite adjective forms a nominal sentence ("The sky is high"), while a definite noun + definite adjective forms a descriptive phrase ("the high sky").
2. **Gender agreement:** The predicate adjective must match the gender of the subject — عَالِيَةٌ (feminine) for ٱلسَّمَاءُ (feminine) and عَمِيقٌ (masculine) for ٱلْبَحْرُ (masculine). This connects to [L1.07](/learn/level-1/07-gender-masculine-feminine/).
