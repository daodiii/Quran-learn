...
- **رَبِّ** (rabbi) — Descriptive appositive
...
- **ٱلْعَٰلَمِينَ** (al-ʿālamīna) — Possessive
...
- **ٱلصِّرَٰطَ** (aṣ-ṣirāṭa) — Direct object
...
- **ٱلَّذِينَ** (alladhīna) — Relative pronoun (second in iḍāfah)
...
- **أَنْعَمْتَ** (anʿamta) — Past tense verb
...
- **مَٰلِكِ** (māliki) — Descriptive appositive
