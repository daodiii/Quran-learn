...
- **Genitive** (jarr / majrūr / جَرّ) — the "of / after a small word" ending, usually a kasra (-i).
...
**Prerequisites:**
- [L1.10: Introduction to Case Endings](/learn/level-1/10-case-endings/) — Recognizing genitive markers visually
...
**Topic Hub:**
- [I’rab Cases: Marfuʻ, Mansub, Majrur](/learn/irab-cases/) — Majrur alongside the other two cases with triggers and a parsing routine
