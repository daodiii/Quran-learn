...
<ArabicExample
  ...
  words={[
    ...
    { ar: "مَلِكِ", tr: "maliki", en: "Sovereign of" },
    { ar: "ٱلنَّاسِ", tr: "n-nāsi", en: "mankind" },
    { ar: "إِلَٰهِ", tr: "ilāhi", en: "God of" },
    { ar: "ٱلنَّاسِ", tr: "n-nāsi", en: "mankind" }
  ]}
/>
...
Idafah appears on almost every line of the Quran. Phrases like رَبُّ ٱلْعَالَمِينَ ("Lord of the worlds"), يَوْمِ ٱلدِّينِ ("Day of Judgment"), and كِتَابُ ٱللَّهِ ("Book of Allah") are ALL idafah constructions. Mastering this one pattern unlocks a massive portion of Quranic vocabulary.
</Callout>

<Callout type="note" title="Quick Win">
بِسْمِ ٱللَّهِ — the phrase you say before everything — contains an idafah: اِسْم (name) + ٱللَّه (Allah) = "name of Allah." You already use idafah dozens of times daily.
</Callout>
...
- **Iḍāfah** (إِضَافَة) — a possession phrase: "the X of Y" (e.g. "the book of the student").
- **Muḍāf** (مُضَاف) — the first noun: the thing owned ("the book").
- **Muḍāf ilayhi** (مُضَاف إِلَيْهِ) — the second noun: the owner ("the student"); it takes the genitive.
- **Genitive** (jarr / majrūr / جَرّ) — the "of" ending, usually a kasra (-i).
</Callout>
...
<ArabicExample
  ...
  words={[
    { ar: "مَٰلِكِ", tr: "māliki", en: "Master of" },
    { ar: "يَوْمِ", tr: "yawmi", en: "Day of" },
    { ar: "ٱلدِّينِ", tr: "d-dīni", en: "the Judgment" }
  ]}
/>
...
<ArabicExample
  ...
  words={[
    { ar: "ٱلصِّرَٰطَ", tr: "aṣ-ṣirāṭa", en: "the path" },
...
<ArabicExample
  ...
  words={[
    { ar: "فَلْيَعْبُدُوا", tr: "fa-l-yaʿbudū", en: "let them worship" },
    { ar: "رَبَّ", tr: "rabba", en: "Lord of" },
    { ar: "هَٰذَاْ", tr: "hādhā", en: "this" },
    { ar: "ٱلْبَيْتِ", tr: "l-bayti", en: "the House" }
  ]}
/>
...
- [L1.06: Definite and Indefinite](/learn/level-1/06-definite-article/) — How definiteness works in Arabic
