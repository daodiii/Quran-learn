...
- **Preposition** (harf jarr / حَرْف جَرّ) — a small linking word like in, from, to, on, with.
- **Genitive** (jarr / majrūr / جَرّ) — the ending a noun takes after a preposition, usually a kasra (-i).
</Callout>
...
- [L1.10: Introduction to Case Endings](/learn/level-1/10-case-endings/) — Recognizing diacritical marks
...
**Topic Hub:**
- [I’rab Cases: Marfuʻ, Mansub, Majrur](/learn/irab-cases/) — How prepositions trigger Majrur, with the full case system and a parsing routine
