...
**Connection:** You've learned word types ([L1.04](/learn/level-1/04-three-word-types/)), the definite article ([L1.06](/learn/level-1/06-definite-article/)), gender ([L1.07](/learn/level-1/07-gender-masculine-feminine/)), and number ([L1.08](/learn/level-1/08-singular-dual-plural/)). Now let's see how words come together to form SENTENCES.
...
**Previous lessons:**
- [Three Word Types](/learn/level-1/04-three-word-types/) — Understanding ism, fiʿl, and ḥarf
- [The Definite Article](/learn/level-1/06-definite-article/) — How to make nouns definite with ال
- [Gender in Arabic](/learn/level-1/07-gender-masculine-feminine/) — Masculine and feminine patterns
- [Number in Arabic](/learn/level-1/08-singular-dual-plural/) — Singular, dual, and plural

**Next lesson:**
- [Introduction to Case Endings](/learn/level-1/10-case-endings/) — Learn why word endings change based on their role in the sentence
