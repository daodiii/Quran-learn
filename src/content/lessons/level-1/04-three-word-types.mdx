...
**Connection:** You can now read Arabic fluently ([L1.01](/learn/level-1/01-arabic-script-vowels/) through [L1.03](/learn/level-1/03-reading-bismillah/)). Understanding begins with recognizing what KIND of word you're reading — is it a thing, an action, or a connector?

<Callout type="tip" title="Why This Matters in Your Quran Reading">
Every word in the Quran is either a noun, a verb, or a particle. This three-way classification is the master key — once you can identify word types, every other grammar rule becomes easier because you know WHAT you're looking at.
</Callout>

<Callout type="note" title="Quick Win">
Open any page of the Quran and try classifying the first 5 words. You'll find particles like وَ and مِنْ, nouns like ٱللَّه and كِتَاب, and verbs like قَالَ. You're already reading Arabic structurally!
</Callout>
...
**Key characteristic — the "tanween test":** If a word can take tanween (those double vowels you learned in [L1.02](/learn/level-1/02-reading-marks/)), it's a noun. If it can take the definite article ال (al-), it's a noun.
...
<ArabicExample
  ...
  words={[
    ...
    { ar: "ءَامَنُوْا", tr: "āmanū", en: "believe" },
    { ar: "وَعَمِلُوْا۟", tr: "wa-ʿamilū", en: "and do" },
...
<ArabicExample
  ...
  words={[
    ...
    { ar: "وَعَمِلُوْا۟", tr: "wa-ʿamilū", en: "and do" },
    { ar: "ٱلصَّٰلِحَٰتِ", tr: "ṣ-ṣāliḥāti", en: "righteous deeds" },
    { ar: "وَتَوَاصَوْا۟", tr: "wa-tawāṣaw", en: "and advise each other to" },
    { ar: "بِٱلْحَقِّ", tr: "bi-l-ḥaqqi", en: "truth" },
    { ar: "وَتَوَاصَوْا۟", tr: "wa-tawāṣaw", en: "and advise each other to" },
    { ar: "بِٱلصَّبْرِ", tr: "bi-ṣ-ṣabri", en: "patience" }
  ]}
/>
...
<ArabicExample
  ...
  words={[
    { ar: "ٱلْحَمْدُ", tr: "al-ḥamdu", en: "Praise" },
...
**Related:** [The Definite Article (Al-)](/learn/level-1/06-definite-article/) — learn more about ال and how it marks nouns
...
**"Every sentence needs a verb"** — Not in Arabic! Arabic has two sentence types: verbal (starts with verb) and nominal (starts with noun). Many Quranic verses are nominal sentences with no verb at all (you'll learn this in [L1.09](/learn/level-1/09-simple-sentences/)).
...
<ExerciseBox question="Verse Discovery: Classify every word in this NEW verse — قَالَ رَبِّ ٱغْفِرْ لِي (Nuh 71:28). Which words are nouns, verbs, and particles?">
...
**Structure:** VERB + NOUN + VERB + PARTICLE
**Meaning:** "He said: My Lord, forgive me!"

**Key takeaway:** Commands like ٱغْفِرْ are verbs too — they point to future time (something you want done).

</ExerciseBox>

<ExerciseBox question="Root Detective: The word عَمِلُوْا۟ (ʿamilū, 'they did') is a verb. Its root letters are ع-م-ل. Can you spot these same root letters in ٱلصَّٰلِحَٰتِ? What root might ٱلصَّٰلِحَٰتِ come from, and is it a noun or verb?">
...
- **Root letters:** ص-ل-ح — you can see them hiding inside: ٱل**صَّ**ـٰ**لِحَ**ـٰتِ
...
<ExerciseBox question="Meaning Prediction: The word ٱلْحَقِّ (al-ḥaqqi) is a NOUN with ال. Based on its classification, what role could it play in a sentence — and can you predict what kind of meaning it carries (a person, thing, quality, or idea)?">
...
**Prerequisites:**
- [Reading Practice with Bismillah](/learn/level-1/03-reading-bismillah/) — Apply all reading rules

**Next Steps:**
- [The Definite Article (Al-)](/learn/level-1/06-definite-article/) — Deep dive into ال and sun/moon letters
- [Gender in Arabic](/learn/level-1/07-gender-masculine-feminine/) — Masculine and feminine nouns
- [Introduction to Simple Sentences](/learn/level-1/09-simple-sentences/) — How word types combine into sentences
