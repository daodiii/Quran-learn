...
**Connection:** In [L1.06](/learn/level-1/three-word-types), you learned that nouns (ism) can take tanween to become indefinite ("a book"). Now learn how to make them definite ("THE book") using ال.
...
**Related:** [Three Word Types](/learn/level-1/three-word-types) — ال only appears on nouns (ism), never on verbs or particles
...
**Prerequisites:**
- [Three Word Types](/learn/level-1/three-word-types) — Understanding that ال only attaches to nouns

**Builds on:**
- [Sukun, Shadda & Tanween](/learn/level-1/sukun-shadda-tanween) — Understanding shadda (doubling) and tanween

**Next Steps:**
- [Gender in Arabic](/learn/level-1/gender-masculine-feminine) — Masculine and feminine nouns with ال
- [Singular, Dual & Plural](/learn/level-1/singular-dual-plural) — Number with definite and indefinite forms
