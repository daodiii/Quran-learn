...
**Connection:** In [L1.10](/learn/level-1/simple-sentences), you learned to identify sentence parts. Now let's see how Arabic MARKS those parts so you can spot them instantly.
...
Arabic has three [grammatical cases](/resources/glossary#irab) (iʿrāb / إِعْرَاب), and each one is marked by a specific vowel pattern you already learned in [L1.02](/learn/level-1/short-vowels) and [L1.04](/learn/level-1/sukun-shadda-tanween)!
...
Remember learning vowels in [L1.02](/learn/level-1/short-vowels)?
- Damma (ـُ) → Nominative
- Fatha (ـَ) → Accusative
- Kasra (ـِ) → Genitive

And tanween in [L1.04](/learn/level-1/sukun-shadda-tanween)?
...
### Reading Skills ✓
- [L1.01](/learn/level-1/alphabet-letter-forms): Read the Arabic alphabet in all its forms
- [L1.02](/learn/level-1/short-vowels): Recognize short vowels (fatha, kasra, damma)
- [L1.03](/learn/level-1/long-vowels-diphthongs): Read long vowels and diphthongs
- [L1.04](/learn/level-1/sukun-shadda-tanween): Understand sukūn, shadda, and tanween
- [L1.05](/learn/level-1/reading-bismillah): Read complete Quranic phrases fluently

### Grammar Foundation ✓
- [L1.06](/learn/level-1/three-word-types): Identify the three word types (ism, fiʿl, ḥarf)
- [L1.07](/learn/level-1/definite-article): Recognize the definite article (al-) and sun/moon letters
- [L1.08](/learn/level-1/gender): Understand masculine and feminine patterns
- [L1.09](/learn/level-1/number): Recognize singular, dual, and plural forms
- [L1.10](/learn/level-1/simple-sentences): Distinguish nominal and verbal sentences
...
**Previous lessons:**
- [Introduction to Simple Sentences](/learn/level-1/simple-sentences) — Understanding sentence types and structure
- [Number in Arabic](/learn/level-1/number) — Singular, dual, and plural patterns
- [Sukūn, Shadda, and Tanween](/learn/level-1/sukun-shadda-tanween) — The marks that become case endings

**Next level:**
- [Level 2 Overview](/learn/level-2) — Core Grammar systematic study
- [Nominative Case](/learn/level-2/nominative-case) — Complete rules for rafʿ
- [Accusative Case](/learn/level-2/accusative-case) — Complete rules for naṣb
- [Genitive Case](/learn/level-2/genitive-case) — Complete rules for jarr
