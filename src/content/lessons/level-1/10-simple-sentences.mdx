...
**Connection:** You've learned word types ([L1.06](/learn/level-1/three-word-types)), the definite article ([L1.07](/learn/level-1/definite-article)), gender ([L1.08](/learn/level-1/gender)), and number ([L1.09](/learn/level-1/number)). Now let's see how words come together to form SENTENCES.
...
**Previous lessons:**
- [Three Word Types](/learn/level-1/three-word-types) — Understanding ism, fiʿl, and ḥarf
- [The Definite Article](/learn/level-1/definite-article) — How to make nouns definite with ال
- [Gender in Arabic](/learn/level-1/gender) — Masculine and feminine patterns
- [Number in Arabic](/learn/level-1/number) — Singular, dual, and plural

**Next lesson:**
- [Introduction to Case Endings](/learn/level-1/case-endings) — Learn why word endings change based on their role in the sentence
