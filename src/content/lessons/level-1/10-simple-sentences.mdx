...
2. **[Subject](/resources/glossary/#fail)** (fāʿil / فَاعِلْ) — the doer of the action
...
**Example 3: Another negated verb**
...
**Analysis:**
- **Sentence type:** Nominal (starts with وَلَآ أَنتُمْ — "and not you")
...
<ExerciseBox title="Exercise 1: Identify the Sentence Type" difficulty="beginner">
...
<ExerciseBox title="Exercise 2: Identify Subject and Predicate" difficulty="beginner">
...
<ExerciseBox title="Exercise 3: Identify Verb and Subject" difficulty="intermediate">
...
<ExerciseBox title="Exercise 4: Construct Your Own" difficulty="intermediate">
