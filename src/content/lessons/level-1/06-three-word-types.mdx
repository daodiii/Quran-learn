...
**Connection:** You can now read Arabic fluently ([L1.01](/learn/level-1/01-alphabet-letter-forms/) through [L1.05](/learn/level-1/05-reading-bismillah/)). Understanding begins with recognizing what KIND of word you're reading — is it a thing, an action, or a connector?
...
**Key characteristic — the "tanween test":** If a word can take tanween (those double vowels you learned in [L1.04](/learn/level-1/04-sukun-shadda-tanween/)), it's a noun. If it can take the definite article ال (al-), it's a noun.
...
**Related:** [The Definite Article (Al-)](/learn/level-1/07-definite-article/) — learn more about ال and how it marks nouns
...
**"Every sentence needs a verb"** — Not in Arabic! Arabic has two sentence types: verbal (starts with verb) and nominal (starts with noun). Many Quranic verses are nominal sentences with no verb at all (you'll learn this in [L1.10](/learn/level-1/10-simple-sentences/)).
...
**Prerequisites:**
- [Reading Practice with Bismillah](/learn/level-1/05-reading-bismillah/) — Apply all reading rules

**Next Steps:**
- [The Definite Article (Al-)](/learn/level-1/07-definite-article/) — Deep dive into ال and sun/moon letters
- [Gender in Arabic](/learn/level-1/08-gender-masculine-feminine/) — Masculine and feminine nouns
- [Introduction to Simple Sentences](/learn/level-1/10-simple-sentences/) — How word types combine into sentences
