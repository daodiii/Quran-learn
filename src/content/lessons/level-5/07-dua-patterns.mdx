...
In [L5.06 Grammar Patterns in Juz 'Amma](/learn/level-5/juz-amma-patterns), you identified recurring patterns across short surahs. Now you'll apply the same 4-step pattern recognition method to a different genre — du'a (supplication) — which appears across the ENTIRE Quran, from the shortest to the longest surahs.
...
**Connection to previous learning:** In [L5.06](/learn/level-5/juz-amma-patterns), you learned the 4-step pattern recognition method and applied it to Juz 'Amma surahs. In [L5.01](/learn/level-5/full-irab-analysis), you mastered the systematic i'rab method. In [L4.03](/learn/level-4/conditional-sentences), you studied conditional sentence structures. Now you'll see how conditionals, imperatives, and vocatives combine in a single genre — du'a.
...
- **ٱهْدِنَا** — Two elements fused into one word:
  - **ٱهْدِ**: Imperative form of the defective verb هَدَى (hadā / to guide), root ه-د-ي. The final ي is deleted in the imperative (defective verb rule from [L4.13](/learn/level-4/defective-verbs))
...
**Pattern observation:** Notice how many du'a verbs are defective (final-weak) — هَدَى, آتَى, وَقَى. This is coincidental to the semantics (guidance, giving, protection are common du'a themes), but it means du'a practice naturally reinforces your [defective verb](/learn/level-4/defective-verbs) recognition skills.
...
- **Prerequisite:** [L5.01 Full I'rab Analysis](/learn/level-5/full-irab-analysis) — the systematic method applied in every analysis
- **Previous:** [L5.06 Grammar Patterns in Juz 'Amma](/learn/level-5/juz-amma-patterns) — the pattern recognition method used here
- **Grammar foundations:** [L4.03 Conditional Sentences](/learn/level-4/conditional-sentences) — conditional structures in du'a; [L3.05 Imperative Mood](/learn/level-3/imperative) — imperative verb forms; [L3.06 Subject Pronouns](/learn/level-3/subject-pronouns) — pronoun systems
- **Next:** [L5.08 Oath Formulas](/learn/level-5/oath-formulas) — another distinctive Quranic pattern type
