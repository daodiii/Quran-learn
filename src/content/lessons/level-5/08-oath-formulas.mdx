...
**Connection to previous learning:** In [L5.06 Conditional Patterns](/learn/level-5/conditional-patterns), you analyzed two-part structures (condition + result). In [L5.07 Negation Patterns](/learn/level-5/negation-patterns), you studied grammatical markers of emphasis. Oath formulas combine these skills: recognizing multi-verse grammatical sequences and understanding how particles create rhetorical emphasis.
...
Here **وَ** connects ٱلصَّفَا and ٱلْمَرْوَةَ as coordinated nouns in a list. Both are accusative (منصوب) because they're the subject of إِنَّ, NOT genitive.
...
- [L5.06 Conditional Patterns](/learn/level-5/conditional-patterns) — two-part structures
- [L5.07 Negation Patterns](/learn/level-5/negation-patterns) — emphatic particles
