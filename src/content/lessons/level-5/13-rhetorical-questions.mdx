...
**Connection to previous learning:** In [L5.04-05](/learn/level-5), you analyzed complete surahs combining grammar and rhetoric. In [L4.16-17](/learn/level-4), you learned rhetorical devices (taqdīm / تَقْدِيمٌ, istiʿārah / اِسْتِعَارَةٌ). Now you'll study one of the most frequent Quranic devices: rhetorical questioning (istifhām / اِسْتِفْهَامٌ).
...
(c) مَا ٱلْقَارِعَةُ [Al-Qari'ah 101:2]
