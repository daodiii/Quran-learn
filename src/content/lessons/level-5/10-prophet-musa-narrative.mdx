...
**Connection to previous learning:** In [L5.09](/learn/level-5/prophet-ibrahim-narrative), you mastered the narrative grammar toolkit with a simpler two-party dialogue. In [L4.03](/learn/level-4/conditional-sentences), you studied conditional structures that appear in Musa's narrative. In [L3.05](/learn/level-3/imperative), you learned imperative forms that dominate divine commands to Musa. Now you'll apply ALL these skills to the Quran's most complex narrative.
...
- رَبِّ: Personal vocative (see [L5.07 Du'a Patterns](/learn/level-5/dua-patterns) — Pattern 2)
...
- **Prerequisite:** [L5.09 Story Narratives: Prophet Ibrahim](/learn/level-5/prophet-ibrahim-narrative) — the narrative grammar toolkit established there
- **Method:** [L5.01 Full I'rab Analysis](/learn/level-5/full-irab-analysis) — the systematic analysis applied throughout
- **Grammar foundations:** [L4.03 Conditional Sentences](/learn/level-4/conditional-sentences) — conditionals in narrative; [L3.05 Imperative Mood](/learn/level-3/imperative) — imperative forms in divine commands; [L3.03 Past Tense](/learn/level-3/past-tense) — past tense conjugation dominating narrative
- **Next:** [L5.11 Dialogue Patterns](/learn/level-5/dialogue-patterns) — generalizing dialogue grammar across ALL Quranic genres
