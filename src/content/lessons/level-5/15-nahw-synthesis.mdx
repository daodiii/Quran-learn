...
<ExerciseBox question="Exercise 1: Sentence Type Analysis (Guided)">
...
(d) أَلَمْ تَرَ كَيْفَ فَعَلَ رَبُّكَ بِأَصْحَابِ ٱلْفِيلِ [Al-Fil 105:1]**(a) Nominal sentence:**
...
<ExerciseBox question="Exercise 2: Case Justification (Intermediate)">
...
5. لَا إِلَٰهَ إِلَّا **هُوَ** [Al-Baqarah 2:255]1. **ٱللَّهَ**: (a) Accusative (مَنْصُوبٌ — fatha on final letter). (b) Ism of إِنَّ (اِسْمُ إِنَّ). (c) إِنَّ puts its ism (subject) in accusative case — this is the defining effect of inna sisters.
...
<ExerciseBox question="Exercise 3: Particle Interaction (Intermediate)">
...
<ExerciseBox question="Exercise 4: Full Nahw Analysis (Advanced — Capstone)">
