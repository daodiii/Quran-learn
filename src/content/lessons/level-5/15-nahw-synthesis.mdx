...
**Connection to previous learning:** In [L2.01-L2.11](/learn/level-2), you mastered sentence types, cases, and particles. In [L4.01-L4.10](/learn/level-4), you studied advanced constructions (hal, tamyiz, conditionals, exceptions, emphasis, negation). In [L5.01-L5.14](/learn/level-5/full-irab-analysis), you applied these skills to complete surahs, pattern recognition, and rhetoric. Every lesson has built toward this moment. Now: independent analysis with minimal guidance.
...
**رَيْبَ**: Ism of لَا النافية للجنس. Case: Accusative (مَنْصُوبٌ مَبْنِيٌّ عَلَى ٱلْفَتْحِ — built on fatha, no tanwin because ism of genus-negating la is built when muḍāf or similar). Function: Subject of the negated clause. Reason: Genus-negating لَا puts its ism in accusative.
...
- **Sentence types:** [L2.01 Nominal](/learn/level-2/nominal-sentence), [L2.03 Verbal](/learn/level-2/verbal-sentence)
- **Case system:** [L2.04 Nominative](/learn/level-2/nominative-case), [L2.05 Accusative](/learn/level-2/accusative-case), [L2.06 Genitive](/learn/level-2/genitive-case)
- **Particles:** [L2.10 Inna Sisters](/learn/level-2/inna-sisters), [L2.11 Kaana Sisters](/learn/level-2/kaana-sisters), [L4.10 Negation](/learn/level-4/negation-particles)
- **Advanced:** [L4.01 Hal](/learn/level-4/hal-clauses), [L4.02 Tamyiz](/learn/level-4/tamyiz), [L4.03-04 Conditionals](/learn/level-4/conditional-sentences), [L4.05 Exceptions](/learn/level-4/exception-particles)
- **Rhetoric:** [L5.12 Parallelism](/learn/level-5/parallelism-repetition), [L5.13 Rhetorical Questions](/learn/level-5/rhetorical-questions), [L5.14 Word Order](/learn/level-5/word-order-emphasis)
- **Next:** [L5.16 Comprehensive Review: Sarf Synthesis](/learn/level-5/sarf-synthesis) — the morphology capstone and FINAL lesson
