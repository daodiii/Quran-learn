...
- Apply the 5-step i'rab method from [L5.01](/learn/level-5/full-irab-analysis) to all 7 verses
...
We'll apply the [5-step systematic method](/learn/level-5/full-irab-analysis) to each verse: (1) Segment, (2) Identify sentence type, (3) Analyze each word (nahw + sarf + balagha), (4) Map relationships, (5) Rhetorical analysis.
...
For complete analysis of the Bismillah including all morphological details, see [L5.01 Full I'rab Analysis Method](/learn/level-5/full-irab-analysis). We'll focus on new observations in the subsequent verses.
...
In [L2.01 Nominal Sentence](/learn/level-2/nominal-sentence), you learned this structure. Here it's used for TIMELESS TRUTH — praise belongs to Allah eternally, not just at one moment (which a verb would imply).
...
For more on taqdim and qasr, see [L4.16 Introduction to Balagha](/learn/level-4/intro-balagha).
...
In [L4.11 Introduction to Weak Verbs](/learn/level-4/weak-verbs-intro), you learned that DEFECTIVE VERBS (verbs with final weak letter ي or و) drop the weak letter in certain forms. The imperative is one of those forms. The kasra on the دِ is a remnant indicating the dropped ي.
...
- [L2.01 Nominal Sentence](/learn/level-2/nominal-sentence) — Foundation for understanding V1-4
- [L2.08 Possessive Idafah](/learn/level-2/possessive-idafah) — Used in V2 (رَبِّ ٱلْعَالَمِينَ) and V4 (مَالِكِ يَوْمِ ٱلدِّينِ)
- [L4.16 Introduction to Balagha](/learn/level-4/intro-balagha) — Rhetorical concepts like taqdim, hadhf, iltifat

**Next Steps:**
- [L5.03 Analyzing Ayat al-Kursi](/learn/level-5/ayat-al-kursi) — Apply the same method to a single long, complex verse
- [L5.04 Analyzing Surah Al-Ikhlas](/learn/level-5/surah-al-ikhlas) — Another complete surah analysis

**Related Topics:**
- [L4.17 Figures of Speech](/learn/level-4/figures-of-speech) — Detailed study of tashbih, isti'arah, hadhf, taqdim
- [L2.09 Adjective Agreement](/learn/level-2/adjective-agreement) — Understanding how adjectives match their nouns (V3-4)
- [L4.11 Introduction to Weak Verbs](/learn/level-4/weak-verbs-intro) — Defective verbs like ٱهْدِنَا (V6)
