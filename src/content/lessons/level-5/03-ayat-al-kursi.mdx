...
- **Verbal sentence** (jumla fiʿliyya / جُمْلَة فِعْلِيَّة) — a "verb sentence": starts with the verb.
...
- **Rhetorical question** (istifhām / اِسْتِفْهَام) — a question asked for effect, not for information.
</Callout>
