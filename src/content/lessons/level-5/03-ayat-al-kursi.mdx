...
<Callout type="info" title="Rhetorical Device: Gradation (Tadarruj)">
...
<Callout type="info" title="What is the Kursi?">
...
<ExerciseBox title="Exercise 1: Identify Negation Types" difficulty="intermediate">
...
5. وَلَا يَـُٔودُهُۥ — Negates: ____________ | Purpose: ____________

<details>
<summary>Show Answer</summary>

1. **لَآ إِلَٰهَ** — Negates: existence of any deity | Purpose: Establishes tawhid (monotheism) through total negation of all deities except Allah
...
<ExerciseBox title="Exercise 2: Analyze the Exception Structures" difficulty="advanced">
...
**Reflection:** How does the grammatical structure of negation + exception (لَآ... إِلَّا) serve the theological message of tawhid?
...
<ExerciseBox title="Exercise 3: Map the Five-Stage Progression" difficulty="advanced">
...
<ExerciseBox title="Exercise 4: Compare Al-Fatiha and Ayat al-Kursi" difficulty="advanced">
...
4. **Write one paragraph explaining how grammar serves theology differently in each text.**

<details>
<summary>Show Example Answer</summary>

1. **Which is more grammatically complex?**
