...
- Apply the [5-step i'rab method](/learn/level-5/full-irab-analysis) to a single long, complex verse
...
**Connection to previous learning:** In [L5.02](/learn/level-5/surah-al-fatiha), you analyzed a complete SURAH (7 verses, 29 words) to see how verses connect. Now you'll analyze a single VERSE (10 clauses, 50 words) to see how clauses layer within one unified statement. Think of L5.02 as analyzing a chapter; L5.03 is analyzing a densely packed paragraph.
...
We'll apply the [5-step systematic method](/learn/level-5/full-irab-analysis) to each major clause.
...
**إِلَّا** (illā):
- **Nahw:** Exception particle (استثناء)
...
For more on exception structures, see [L4.04 Exception Structures](/learn/level-4/exception-structures).
...
This pattern appears frequently in Quranic rhetoric. For more, see [L4.17 Figures of Speech](/learn/level-4/figures-of-speech).
...
For more on rhetorical questions, see [L5.13 Rhetorical Questions in the Quran](/learn/level-5/rhetorical-questions).
...
- **Nahw:** Jarr wa-majrur متعلق بِ يُحِيطُونَ, genitive (tanwin kasra)
...
**Prerequisites:**
- [L5.01 Full I'rab Analysis Method](/learn/level-5/full-irab-analysis) — The 5-step systematic method applied throughout this lesson
- [L5.02 Analyzing Surah Al-Fatiha](/learn/level-5/surah-al-fatiha) — Complete surah analysis (multi-verse structure)
- [L4.04 Exception Structures](/learn/level-4/exception-structures) — Understanding إِلَّا and istithnā'
- [L4.10 Negation Particles](/learn/level-4/negation-particles) — Understanding لَا and other negation forms

**Next Steps:**
- [L5.04 Analyzing Surah Al-Ikhlas](/learn/level-5/surah-al-ikhlas) — Another complete surah analysis focusing on tawhid
- [L5.05 Analyzing Surah Al-Falaq & An-Nas](/learn/level-5/surah-al-falaq-an-nas) — Paired surahs with refuge-seeking themes

**Related Topics:**
- [L4.16 Introduction to Balagha](/learn/level-4/intro-balagha) — Rhetorical concepts like taqdim, hadhf
- [L4.17 Figures of Speech](/learn/level-4/figures-of-speech) — Detailed study of rhetorical devices
- [L2.01 Nominal Sentence](/learn/level-2/nominal-sentence) — Foundation for understanding nominal structures throughout the verse
