...
**Connection to previous learning:** In [Level 2](/learn/level-2), you mastered case endings and sentence structures. In [Level 3](/learn/level-3), you explored morphology and word patterns. In [Level 4](/learn/level-4), you studied advanced constructions and rhetoric. Now you'll apply ALL of these tools to every word in a verse at the same time.
...
**Connection to prior learning:** All of [Level 2, Lessons 4-6](/learn/level-2) covered case theory. Step 3 applies those rules to every word.
...
**Connection to prior learning:** All of [Level 3](/learn/level-3) covered morphology. Step 3 applies sarf analysis to every word alongside nahw.
...
2. **Rhetorical device:** What figure of speech is being employed?
   ...
   - And many others (see [L4.16-17](/learn/level-4/intro-balagha))
...
**Connection to prior learning:** [L4.16 Introduction to Balagha](/learn/level-4/intro-balagha) and [L4.17 Figures of Speech](/learn/level-4/figures-of-speech) introduced these concepts. Now you apply them systematically to every verse.
...
| 2 | تَحْدِيدُ نَوْعِ ٱلْجُمْلَةِ<br/>taḥdīdu nawʿi l-jumlati | Nominal or verbal sentence? Any ellipsis? | [L1.10](/learn/level-1/sentence-types), [L2.01-03](/learn/level-2) |
| 3 | ٱلْإِعْرَابُ ٱلتَّفْصِيلِيُّ<br/>al-iʿrābu t-tafṣīliyyu | What is each word's function, form, and rhetorical role? | [L2.04-06](/learn/level-2) (cases), [L3.01-18](/learn/level-3) (morphology), [L4.16-17](/learn/level-4) (balagha) |
| 4 | رَسْمُ ٱلْعَلَاقَاتِ<br/>rasmu l-ʿalāqāti | How do words connect? | [L2.07-11](/learn/level-2) (idafah, adjectives), [L4.01-15](/learn/level-4) (advanced structures) |
| 5 | ٱلتَّحْلِيلُ ٱلْبَلَاغِيُّ<br/>at-taḥlīlu l-balāghiyyu | Why this arrangement? What's the rhetorical effect? | [L4.16-17](/learn/level-4) (balagha branches, figures of speech) |
</GrammarTable>
...
- **Reason:** Follows the preposition بِـ; all nouns after prepositions take jarr case ([L2.04](/learn/level-2/nominative-case))
...
- **Definiteness:** Made definite through **idafah** (possession construction) — بِسْمِ is the mudaf (first term), ٱللَّهِ is the mudaf ilayh (second term). The second term's definiteness makes the entire construction definite ([L2.10](/learn/level-2/idafah-possession))
...
- **Reason:** All mudaf ilayh (second terms of idafah) take jarr case ([L2.10](/learn/level-2/idafah-possession))
...
- **Reason:** Adjectives must agree with the noun they modify in case, number, gender, and definiteness ([L2.11](/learn/level-2/adjectives-descriptive)). Since ٱللَّهِ is genitive, definite, singular, masculine, so is ٱلرَّحْمَٰنِ.
...
4. Reason: Subjects of nominal sentences always take nominative case ([L2.04](/learn/level-2/nominative-case))
...
4. Reason: Nouns following prepositions (لِـ in this case) always take genitive case ([L2.06](/learn/level-2/genitive-case))
...
- [L2.04-06 Case System](/learn/level-2/nominative-case) — You must master case theory to perform syntactic analysis
- [L2.10 Idafah (Possession)](/learn/level-2/idafah-possession) — Idafah appears in nearly every verse
- [L2.11 Adjectives](/learn/level-2/adjectives-descriptive) — Adjective agreement is critical for Step 3
- [L3.01 Root System](/learn/level-3/roots-intro) — Morphological analysis requires root identification
- [L4.16-17 Balagha](/learn/level-4/intro-balagha) — Rhetorical analysis (Step 5) builds on these concepts

**Next Lessons (Applying This Method):**
- [L5.02 Analyzing Surah Al-Fatiha](/learn/level-5/surah-al-fatiha-analysis) — Apply the 5-step method to the complete Fatiha
- [L5.03 Analyzing Ayat al-Kursi](/learn/level-5/ayat-al-kursi-analysis) — Systematic analysis of a longer, complex verse

**Parallel Study:**
- [L5.04 Advanced Morphology in Context](/learn/level-5/advanced-morphology-context) — Deepens Step 3 sarf analysis
- [L5.05 Sentence Parsing Strategies](/learn/level-5/sentence-parsing-strategies) — Advanced techniques for Step 4 relationship mapping
