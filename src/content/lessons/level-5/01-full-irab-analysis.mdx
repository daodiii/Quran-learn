...
- **Iʿrāb** (إِعْرَاب) — full parsing: naming each word's job in the sentence and the case it takes.
- **Naḥw** (نَحْو) — syntax: how words fit together into sentences.
- **Ṣarf** (صَرْف) — morphology: how each single word is built from its root.
- **Nominal sentence** (jumla ismiyya / جُمْلَة اِسْمِيَّة) — a "noun sentence": starts with a noun, needs no verb.
- **Mubtadaʾ** (مُبْتَدَأ) — the starting word: the thing the sentence is about.
- **Khabar** (خَبَر) — the "news": what is said about the mubtadaʾ.
</Callout>
...
2. **Rhetorical device:** What figure of speech is being employed?
   ...
   - And many others (see [L4.17-18](/learn/level-4/17-intro-balagha/))
...
**Connection to prior learning:** [L4.17 Introduction to Balagha](/learn/level-4/17-intro-balagha/) and [L4.18 Figures of Speech](/learn/level-4/18-figures-of-speech/) introduced these concepts. Now you apply them systematically to every verse.
...
| 2 | تَحْدِيدُ نَوْعِ ٱلْجُمْلَةِ<br/>taḥdīdu nawʿi l-jumlati | Nominal or verbal sentence? Any ellipsis? | [L1.09](/learn/level-1/09-simple-sentences/), [L2.01-03](/learn/level-2/01-nominal-sentence/) |
| 3 | ٱلْإِعْرَابُ ٱلتَّفْصِيلِيُّ<br/>al-iʿrābu t-tafṣīliyyu | What is each word's function, form, and rhetorical role? | [L2.04-06](/learn/level-2/01-nominal-sentence/) (cases), [L3.01-18](/learn/level-3/01-root-system/) (morphology), [L4.17-18](/learn/level-4/01-hal-clauses/) (balagha) |
...
| 5 | ٱلتَّحْلِيلُ ٱلْبَلَاغِيُّ<br/>at-taḥlīlu l-balāghiyyu | Why this arrangement? What's the rhetorical effect? | [L4.17-18](/learn/level-4/01-hal-clauses/) (balagha branches, figures of speech) |
</GrammarTable>
...
<ExerciseBox question="Exercise 1: Method Application (Guided)">
...
3. Identify any ellipsis**Step 1: Segmentation**
...
<ExerciseBox question="Exercise 2: Word Analysis (Intermediate)">
...
4. Reason (why this case?)**Word 1: ٱلْحَمْدُ**
...
<ExerciseBox question="Exercise 3: Relationship Mapping (Intermediate)">
...
<ExerciseBox question="Exercise 4: Full Analysis (Advanced)">
...
4. Relationship map
5. At least ONE balagha observation**Step 1: Segmentation**
...
- [L4.17-18 Balagha](/learn/level-4/17-intro-balagha/) — Rhetorical analysis (Step 5) builds on these concepts
...
**Topic Hub:** See [I’rab Cases: Marfuʻ, Mansub, Majrur](/learn/irab-cases/) for the unified case-system reference and a 4-step parsing routine that complements the 5-step analysis method here.
