...
You've analyzed complete surahs ([L5.02 Al-Fatiha](/learn/level-5/surah-al-fatiha), [L5.03 Ayat al-Kursi](/learn/level-5/ayat-al-kursi)) and short surahs ([L5.04 Al-Ikhlas](/learn/level-5/surah-al-ikhlas), [L5.05 Al-Falaq & An-Nas](/learn/level-5/surah-al-falaq-an-nas)). Now you'll analyze NARRATIVE passages — a different Quranic genre with its own distinctive grammar.
...
**Connection to previous learning:** In [L5.01](/learn/level-5/full-irab-analysis), you learned the systematic 5-step i'rab method. In [L4.03](/learn/level-4/conditional-sentences), you studied conditionals. In [L3.03](/learn/level-3/past-tense), you mastered past tense conjugation. This lesson synthesizes ALL these skills to analyze narrative passages as unified grammatical structures.
...
Narrative events are told in **past tense** (الفِعْل المَاضِي / al-fiʿl al-māḍī). Even when the event is eternally relevant or contains timeless lessons, the GRAMMAR uses past tense to establish the narrative as a completed historical event.
...
The word قَالَ (qāla / "he said") and its variations function as **dialogue markers** (علامات الحوار / ʿalāmāt al-ḥiwār). These markers introduce direct speech and track who is speaking.
...
After a dialogue marker, the text shifts to **quoted speech** (الكلام المنقول / al-kalām al-manqūl). Quoted speech is grammatically independent from the narrative frame. It can be in ANY tense, mood, or sentence type — questions, commands, statements.
...
Quranic narratives track speaker changes through **verb agreement** (التوافق الفعلي / at-tawāfuq al-fiʿlī). The number and gender of the verb قَالَ tells you WHO is speaking.
...
- **[L5.01: Full I'rab Analysis Method](/learn/level-5/full-irab-analysis)** — Apply the systematic 5-step method to narrative passages
- **[L4.03: Conditional Sentences](/learn/level-4/conditional-sentences)** — Master conditionals used in narrative cause-effect structures
- **[L3.03: Past Tense Conjugation](/learn/level-3/past-tense)** — Review past tense patterns that dominate narratives
- **[L5.10: Story Narratives: Prophet Musa](/learn/level-5/prophet-musa-narrative)** — Apply narrative grammar to more complex multi-speaker dialogues
- **[L3.05: Imperative Mood](/learn/level-3/imperative)** — Understand imperatives in quoted speech (commands from Allah)
