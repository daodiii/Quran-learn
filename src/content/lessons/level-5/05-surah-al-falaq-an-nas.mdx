...
<Callout type="insight" title="Why Analyze Two Surahs Together">
...
<Callout type="context" title="Historical Context">
...
<Callout type="insight" title="One Threat, Three Attributes">
...
<Callout type="insight" title="Final Occurrence of النَّاس">
...
<ExerciseBox title="Exercise 1: Parallel Structure Analysis (Guided)">
...
3. What grammatical function do مَلِكِِ and إِلَٰهِِ serve in relation to رَبِّ?

<details>
<summary>Show Answer</summary>

**1. After the shared opening:**
...
<ExerciseBox title="Exercise 2: Participle vs. Intensive Pattern Analysis (Intermediate)">
...
4. Why do you think Al-Falaq uses active participles while An-Nas uses intensive patterns?
...
<ExerciseBox title="Exercise 3: Independent I'rab Analysis (Intermediate)">
...
3. Root
4. Meaning
5. Relationship to other words in the phrase

<details>
<summary>Show Answer</summary>

**مِن شَرِّ مَا خَلَقَ** (min sharri mā khalaqa)
...
<ExerciseBox title="Exercise 4: Comparative Synthesis (Advanced)">
...
4. How this repetition serves the surah's overall message

<details>
<summary>Show Answer</summary>

**1. Occurrences of النَّاس:**
