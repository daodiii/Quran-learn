...
<ArabicExample
  ...
  words={[
    ...
    { ar: "وَلَمْ", tr: "wa-lam", en: "and not" },
    { ar: "يَكُنْ", tr: "yakun", en: "is there" },
...
<Callout type="tip" title="From Examples to Complete Analysis">
...
<Callout type="warning" title="Scholarly Debate: Ḍamīr al-Sha'n">
...
<Callout type="tip" title="Connection to L4.10 Negation">
...
<Callout type="tip" title="Taqdim as Theological Tool">
...
<ExerciseBox question="Exercise 1: Verb Analysis (Guided)">
...
5. Why the voice changes between these two verbs**يَلِدْ (yalid):**
1. Root: و-ل-د (w-l-d)
2. Form: Form I
3. Voice: Active
...
<ExerciseBox question="Exercise 2: Taqdim Analysis (Intermediate)">
...
4. Explain the rhetorical effect of this inversion**1. Standard word order:**
...
<ExerciseBox question="Exercise 3: Definiteness Patterns (Intermediate)">
...
3. What rhetorical purpose does each definiteness pattern serve?**1. Definiteness tracking:**
...
<ExerciseBox question="Exercise 4: Complete Analysis (Advanced)">
