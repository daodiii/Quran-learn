...
**Connection to previous learning:** In [L5.01 Full I'rab Analysis](/learn/level-5/full-irab-analysis), you learned the 5-step method for complete verse analysis. In [L5.02 Al-Fatiha Analysis](/learn/level-5/fatiha-analysis), you applied this method to a longer surah (7 verses). Now apply it to Al-Ikhlas — shorter in length but deeper in theological concentration.

<Callout type="insight" title="From Examples to Complete Analysis">
You've seen individual verses from Al-Ikhlas in [L2.01 Nominal Sentences](/learn/level-2/nominal-sentence) and other lessons. Those were isolated examples. This lesson reveals how all four verses form an integrated grammatical and theological whole.
</Callout>
...
In [L4.10 Negation Particles](/learn/level-4/negation-particles), you learned that لَمْ is unique among negation particles — it uses PRESENT verb form with PAST meaning. Here you see this principle in action: لَمْ يَلِدْ uses present form يَلِدْ to express eternal past negation.
</Callout>
...
**Nahw (syntax):** This sentence features kaana (كَانَ), one of the incomplete verbs you learned in [L2.10 Kaana and Her Sisters](/learn/level-2/kaana-sisters). The normal word order would be:
...
In [L5.02 Al-Fatiha Analysis](/learn/level-5/fatiha-analysis), you analyzed a longer surah with varied sentence types. Al-Ikhlas provides a different model:
...
**Task:** Perform a full 5-step i'rab analysis of Verse 2 using the method from [L5.01](/learn/level-5/full-irab-analysis).
...
- [L2.01 Nominal Sentences](/learn/level-2/nominal-sentence) — Foundational understanding of mubtadaʾ-khabar structure
- [L2.10 Kaana and Her Sisters](/learn/level-2/kaana-sisters) — Verse 4 uses kaana as an incomplete verb
- [L4.10 Negation Particles](/learn/level-4/negation-particles) — Verses 3-4 use لَمْ for past negation

**Related lessons:**
- [L5.02 Al-Fatiha Analysis](/learn/level-5/fatiha-analysis) — Longer surah analysis for comparison
- [L5.05 Al-Falaq & An-Nas Analysis](/learn/level-5/falaq-nas-analysis) — Paired surahs with parallel structures

**What's next:**
- [L5.05 Analyzing Al-Falaq & An-Nas](/learn/level-5/falaq-nas-analysis) — Analyze two related surahs together, comparing their structures
