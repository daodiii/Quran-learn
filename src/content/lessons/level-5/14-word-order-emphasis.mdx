...
**Connection to previous learning:** In [L4.16 Introduction to Balagha](/learn/level-4/intro-balagha) and [L4.17 Figures of Speech](/learn/level-4/figures-of-speech), you learned that taqdim (fronting) is one of the five essential rhetorical figures. In [L5.12 Parallelism & Repetition](/learn/level-5/parallelism-repetition) and [L5.13 Rhetorical Questions](/learn/level-5/rhetorical-questions), you analyzed other rhetoric devices. This lesson completes the applied rhetoric section (L5.12-14).
...
- **Rhetoric foundations:** [L4.16 Introduction to Balagha](/learn/level-4/intro-balagha) — taqdim introduced; [L4.17 Figures of Speech](/learn/level-4/figures-of-speech) — five rhetorical figures
- **Applied rhetoric series:** [L5.12 Parallelism & Repetition](/learn/level-5/parallelism-repetition) — parallel structures; [L5.13 Rhetorical Questions](/learn/level-5/rhetorical-questions) — interrogative rhetoric
- **Sentence structure:** [L2.01 Nominal Sentence](/learn/level-2/nominal-sentence) — mubtada/khabar order; [L2.03 Verbal Sentence](/learn/level-2/verbal-sentence) — VSO order
- **Next:** [L5.15 Comprehensive Review: Nahw Synthesis](/learn/level-5/nahw-synthesis) — synthesizing ALL syntax knowledge
