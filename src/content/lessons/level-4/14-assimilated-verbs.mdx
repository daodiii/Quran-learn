...
**Connection to previous learning:** In [L4.12 Hollow Verbs](/learn/level-4/hollow-verbs), you learned middle-weak contraction (3 principles). In [L4.13 Defective Verbs](/learn/level-4/defective-verbs), you learned final-weak transformation (mood interaction). Assimilated verbs are MUCH SIMPLER — just ONE rule: initial و drops in present tense Form I.

**Forward connection:** After assimilated verbs, [L4.15 Hamzated Verbs](/learn/level-4/hamzated-verbs) completes the weak verb system with hamza spelling rules. You'll then have mastered ALL four weak verb categories!
...
**Next steps:**
- [L4.15 Hamzated Verbs](/learn/level-4/hamzated-verbs) — Complete weak verb system with hamza spelling rules
- [L4.16 Introduction to Balagha](/learn/level-4/intro-balagha) — Begin rhetorical figures in Quranic style
- [L5.01 Advanced Morphology](/learn/level-5/advanced-morphology) — Combine all weak verb knowledge

**Weak verb mastery progress:**
- ✓ [L4.12 Hollow Verbs](/learn/level-4/hollow-verbs) — Middle-weak (3 contraction principles)
- ✓ [L4.13 Defective Verbs](/learn/level-4/defective-verbs) — Final-weak (mood interaction)
- ✓ **L4.14 Assimilated Verbs** — Initial-weak (simple deletion)
- → Next: [L4.15 Hamzated Verbs](/learn/level-4/hamzated-verbs) — Hamza spelling
