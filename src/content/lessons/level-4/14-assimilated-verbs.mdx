...
<ArabicExample
  ...
  words={[
    ...
    { ar: "ضَآلًّا", tr: "ḍāllan", en: "lost" },
    { ar: "فَهَدَىٰ", tr: "fa-hadā", en: "and guided" }
  ]}
/>
...
- **Assimilated verb** (mithāl / مِثَال) — a verb whose *first* root letter is weak (like waṣala).
</Callout>
...
<VerbConjugation
  question="Present Tense Comparison: يَنْصُرُ (sound) vs يَجِدُ (assimilated)"
  soundRoot="ن-ص-ر"
  hollowRoot="و-ج-د"
>
...
Let's see the same verb وَجَدَ in past tense where the و STAYS. Press each person and watch the و hold its place — only the suffix changes:

<ConjugationEngine
  roots={[
    { id: "wajada", letters: "و-ج-د", gloss: "to find", stem: "وَجَد", tr: "wajad" }
  ]}
  persons={[
    ...
    { suffix: "ْتُمَاْ", tr: "tumā", pronoun: "أَنْتُمَا", label: "2nd dual", behaviour: 2 },
...
<ArabicExample
  ...
  words={[
    ...
    { ar: "تَجِدُ", tr: "tajidu", en: "you will find" },
    { ar: "لَهُمْ", tr: "lahum", en: "for them" },
    { ar: "مِنْ", tr: "min", en: "from" },
    { ar: "دُونِ", tr: "dūni", en: "besides" },
    { ar: "ٱللَّهِ", tr: "llāhi", en: "Allah" },
    { ar: "وَلِيًّا", tr: "waliyyan", en: "a protector" },
    { ar: "وَلَا", tr: "wa-lā", en: "and not" },
    { ar: "نَصِيرًا", tr: "naṣīran", en: "a helper" }
  ]}
/>
...
<ArabicExample
  ...
  words={[
    ...
    { ar: "يَتِيمًا", tr: "yatīman", en: "an orphan" },
    { ar: "فَـَٔاوَىٰ", tr: "fa-āwā", en: "and shelter" },
    { ar: "وَوَجَدَكَ", tr: "wa-wajadaka", en: "and He found you" },
    { ar: "ضَآلًّا", tr: "ḍāllan", en: "lost" },
    { ar: "فَهَدَىٰ", tr: "fa-hadā", en: "and guided" },
    { ar: "وَوَجَدَكَ", tr: "wa-wajadaka", en: "and He found you" },
    { ar: "عَآئِلًا", tr: "ʿāʾilan", en: "poor" },
    { ar: "فَأَغْنَىٰ", tr: "fa-aghnā", en: "and enriched" }
  ]}
/>
...
<Callout type="note" title="Al-Duha's Theological Message">
...
<ExerciseBox
  question="Exercise 1: Identify Assimilated Verbs"
>
...
<ExerciseBox
  question="Exercise 2: Apply Deletion Rule"
>
...
<ExerciseBox
  question="Exercise 3: Tense Identification"
>
...
<ExerciseBox
  question="Exercise 4: Al-Duha Analysis"
>
...
- [L4.17 Introduction to Balagha](/learn/level-4/17-intro-balagha/) — Begin rhetorical figures in Quranic style
