...
**Connection to previous learning:** In [L4.12 Hollow Verbs](/learn/level-4/hollow-verbs), you learned how middle weak letters contract or drop. Defective verbs use SIMILAR logic, but the weak letter is in the FINAL position, so it interacts with case endings (nominative/accusative/genitive) and mood markers (indicative/subjunctive/jussive) that you learned in [L2.04](/learn/level-2/nominative-case) through [L2.06](/learn/level-2/genitive-case).

**Forward connection:** After defective verbs, [L4.14 Assimilated Verbs](/learn/level-4/assimilated-verbs) will be straightforward — initial-weak position is the SIMPLEST category. Then [L4.15 Hamzated Verbs](/learn/level-4/hamzated-verbs) completes the weak verb system.
...
**Next steps:**
- [L4.14 Assimilated Verbs](/learn/level-4/assimilated-verbs) — Master initial-weak position (simplest category!)
- [L4.15 Hamzated Verbs](/learn/level-4/hamzated-verbs) — Handle hamza spelling rules
- [L5.01 Advanced Morphology](/learn/level-5/advanced-morphology) — Combine weak verb knowledge with complex patterns
