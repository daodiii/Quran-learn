...
<VerbConjugation
  title="Past Tense Comparison: كَتَبَ (sound) vs هَدَىٰ (defective)"
  soundRoot="ك-ت-ب"
  hollowRoot="ه-د-ي"
>
...
<VerbConjugation
  title="Present Tense Moods: يَهْدِي (defective-ya)"
  root="ه-د-ي"
>
...
### Example 2: هَدَى (hadā) in Descriptive Context

<ArabicExample
  arabic="ٱلَّذِينَ أَنْعَمْتَ عَلَيْهِمْ"
  transliteration="alladhīna anʿamta ʿalayhim"
  translation="Those upon whom You have bestowed favor"
...
**Note on connection:** While this verse doesn't directly contain هَدَى, it describes "those You have blessed" — namely, those whom Allah has GUIDED (هَدَى). The guided people (ٱلْمُهْتَدُونَ) are derived from the root ه-د-ي using Form VIII اِهْتَدَى (ihtadā) "to be guided."

The straight path (ٱلصِّرَٰطَ ٱلْمُسْتَقِيمَ) is the path of guidance — those whom Allah has guided walk on it.

### Example 3: Understanding "Guidance" Root Family

The root ه-د-ي appears in multiple forms throughout the Quran:

**Root ه-د-ي derivations:**
- هَدَى (hadā) — Form I: "he guided"
- يَهْدِي (yahdī) — Form I present: "he guides"
- ٱِهْدِنَا (ihdinā) — Form I imperative: "guide us!"
- ٱِهْتَدَى (ihtadā) — Form VIII: "he was guided / he followed guidance"
- هُدًى (hudan) — Masdar: "guidance" (noun)
- مُهْتَدٍ (muhtadin) — Active participle Form VIII: "one who is guided"

All share the defective-ya root pattern with final ي transformations!

<Callout type="info" title="Al-Fatiha's Theological Core">
...
<ExerciseBox
  title="Exercise 1: Identify Defective Verbs"
  instructions="For each root, determine if it's a defective verb. If yes, state whether it's defective-waw or defective-ya."
>
...
<ExerciseBox
  title="Exercise 2: Apply Transformation Principles"
  instructions="Using the three transformation principles, predict the conjugation for each defective verb."
>
...
<ExerciseBox
  ...
  instructions="Conjugate the defective verb ر-م-ي (r-m-y) 'throwing' in the following forms."
>
...
<ExerciseBox
  title="Exercise 4: Al-Fatiha Root Analysis"
  instructions="Analyze the root ه-د-ي (h-d-y) in Al-Fatiha. Identify how the imperative ٱِهْدِنَا demonstrates defective verb characteristics."
>
