...
**Forward connection:** This lesson prepares you for [L4.17 Introduction to Balagha (Rhetoric)](/learn/level-4/17-intro-balagha/), where emphasis is one of three major rhetorical categories in Arabic linguistic analysis.
...
- **Emphasis** (tawkīd / تَوْكِيد) — words or particles that strengthen a statement ("indeed", "surely").
</Callout>
