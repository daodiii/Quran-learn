...
**Connection to previous learning:** In [L2.05 The Accusative Case](/learn/level-2/accusative-case), you learned that the direct object takes accusative. Exception structures use EITHER accusative OR the case of the excepted-from word, depending on sentence completeness and negation.

**Forward connection:** This lesson prepares you for [L5.01 Rhetorical Analysis](/learn/level-5/introduction-balagha), where you'll see how exception structures create emphasis and theological precision in Quranic discourse.
...
**Next lesson:** [L4.06 Emphasis & Affirmation (Tawkid)](/learn/level-4/emphasis-affirmation) — Learn how Arabic uses particles like إِنَّ, قَدْ, and لَقَدْ to create emphatic structures in Quranic oaths and assertions.
