...
<ArabicExample
  ...
  words={[
    ...
    { ar: "زُلْزِلَتِ", tr: "zulzilati", en: "is shaken" },
    { ar: "ٱلْأَرْضُ", tr: "l-arḍu", en: "the earth" },
    { ar: "زِلْزَالَهَا", tr: "zilzālahā", en: "its earthquake" }
  ]}
/>
...
**Connection to previous learning:** In [L2.05 Accusative Case](/learn/level-2/05-accusative-case/), you learned that accusative marks objects and circumstances. In [L3.20 Verbal Nouns (Masdar)](/learn/level-3/20-verbal-nouns/), you learned how verbs generate abstract action nouns. Now you'll see how the masdar appears IN SENTENCES as an accusative absolute object to emphasize or specify the action.
...
<ArabicExample
  ...
  words={[
    { ar: "فَلَا", tr: "fa-lā", en: "so do not" },
    { ar: "تَمِيلُوا", tr: "tamīlū", en: "incline" },
    { ar: "كُلَّ", tr: "kulla", en: "all" },
    { ar: "ٱلْمَيْلِ", tr: "l-mayli", en: "the inclination" }
  ]}
/>
...
<ArabicExample
  ...
  words={[
    { ar: "فَٱجْلِدُوهُمْ", tr: "fa-jlidūhum", en: "then lash them" },
    { ar: "ثَمَٰنِينَ", tr: "thamānīna", en: "eighty" },
    { ar: "جَلْدَةً", tr: "jaldatan", en: "lashes" }
  ]}
/>
...
<ArabicExample
  ...
  words={[
    ...
    { ar: "رِسَالَةً", tr: "risālatan", en: "a letter" }
  ]}
/>
...
<Callout type="tip" title="Two accusatives in one sentence">
...
<ArabicExample
  ...
  words={[
    { ar: "وَأَخْرَجَتِ", tr: "wa-akhrajati", en: "and discharges" },
    { ar: "ٱلْأَرْضُ", tr: "l-arḍu", en: "the earth" },
    { ar: "أَثْقَالَهَا", tr: "athqālahā", en: "its burdens" }
  ]}
/>
...
<ExerciseBox question="Exercise 1: Identify the Maf'ul Mutlaq">

Identify the absolute object in each sentence and state its function (emphasis, type, or number).

**1. إِذَا زُلْزِلَتِ ٱلْأَرْضُ زِلْزَالَهَا (idhā zulzilati l-arḍu zilzālahā) — Al-Zilzal 99:1**

Maf'ul mutlaq: زِلْزَالَهَا (zilzālahā). Root: ز-ل-ز-ل (same as verb زُلْزِلَتِ). Function: EMPHASIS — the earth will shake with its ULTIMATE, COMPLETE earthquake. Case: Accusative (implied before pronoun attachment).

**2. فَٱجْلِدُوهُمْ ثَمَٰنِينَ جَلْدَةً (fa-jlidūhum thamānīna jaldatan) — An-Nur 24:4**

Maf'ul mutlaq: جَلْدَةً (jaldatan). Root: ج-ل-د (same as verb ٱجْلِدُوهُمْ). Function: NUMBER — specifies the action occurs eighty times. Case: Accusative with tanwin (ـًا).

**3. فَلَا تَمِيلُوا كُلَّ ٱلْمَيْلِ (fa-lā tamīlū kulla l-mayli) — An-Nisa 4:129**

Maf'ul mutlaq: كُلَّ ٱلْمَيْلِ (kulla l-mayli). Root: م-ي-ل (same as verb tamīlū). Function: TYPE — specifies COMPLETE/TOTAL inclination. Case: كُلَّ is accusative, ٱلْمَيْلِ is genitive (mudaf ilayhi).

**4. وَكَلَّمَ ٱللَّهُ مُوسَىٰ تَكْلِيمًا (wa-kallama llāhu mūsā taklīman) — An-Nisa 4:164**

Maf'ul mutlaq: تَكْلِيمًا (taklīman). Root: ك-ل-م (same as verb كَلَّمَ). Function: EMPHASIS — Allah spoke to Moses with DIRECT, REAL speech (emphasizes the reality of divine speech). Case: Accusative with tanwin (ـًا).

</ExerciseBox>

<ExerciseBox question="Exercise 2: Maf'ul Mutlaq vs. Direct Object">

Determine whether the accusative noun is a maf'ul mutlaq (same root) or direct object (different root).

**1. كَتَبَ ٱلطَّالِبُ رِسَالَةً (kataba ṭ-ṭālibu risālatan) — 'The student wrote a letter'**

DIRECT OBJECT. رِسَالَةً (risālatan) 'a letter' has root ر-س-ل, different from verb كَتَبَ (root ك-ت-ب). It receives the action (what was written), not repeating the verb's meaning.

**2. كَتَبَ ٱلطَّالِبُ كِتَابَةً (kataba ṭ-ṭālibu kitābatan) — 'The student wrote (intensely)'**

MAF'UL MUTLAQ. كِتَابَةً (kitābatan) 'writing' is the masdar from the same root ك-ت-ب as the verb. Function: EMPHASIS. It doesn't introduce a new element — it intensifies the writing action itself.

**3. وَأَخْرَجَتِ ٱلْأَرْضُ أَثْقَالَهَا (wa-akhrajati l-arḍu athqālahā) — 'The earth discharged its burdens'**

DIRECT OBJECT. أَثْقَالَهَا (athqālahā) 'its burdens' has root ث-ق-ل, different from verb أَخْرَجَتِ (root خ-ر-ج). It receives the action (what was discharged).

</ExerciseBox>

<ExerciseBox question="Exercise 3: Determine Maf'ul Mutlaq Function">

Identify whether the absolute object serves emphasis, type specification, or number specification.

**1. ضَرَبَ ٱلْمُعَلِّمُ ٱلطَّالِبَ ضَرْبًا (ḍaraba l-muʿallimu ṭ-ṭāliba ḍarban) — 'The teacher struck the student (emphatically)'**

Function: EMPHASIS. ضَرْبًا (ḍarban) is the bare masdar without adjective or number, emphasizing the striking action occurred forcefully or completely. Root: ض-ر-ب (same as verb).

**2. ضَرَبَ ٱلْمُعَلِّمُ ٱلطَّالِبَ ضَرْبًا شَدِيدًا (ḍaraba l-muʿallimu ṭ-ṭāliba ḍarban shadīdan) — 'The teacher struck the student severely'**

Function: TYPE. ضَرْبًا شَدِيدًا (ḍarban shadīdan) 'a severe striking' has an adjective شَدِيدًا (shadīdan) specifying WHAT KIND of striking — severe, intense. Root: ض-ر-ب.

**3. ضَرَبَ ٱلْمُعَلِّمُ ٱلطَّالِبَ ضَرْبَتَيْنِ (ḍaraba l-muʿallimu ṭ-ṭāliba ḍarbatayni) — 'The teacher struck the student twice'**

Function: NUMBER. ضَرْبَتَيْنِ (ḍarbatayni) is the dual form 'two strikes' specifying exactly HOW MANY TIMES the action occurred. Root: ض-ر-ب.

</ExerciseBox>

<ExerciseBox question="Exercise 4: Root Analysis">

Verify the same-root requirement by identifying the verb root and masdar root.

**1. Verb: زُلْزِلَتِ (zulzilat) 'was shaken'. Maf'ul mutlaq: زِلْزَالَهَا (zilzālahā) 'its earthquake'**

Verb root: ز-ل-ز-ل (z-l-z-l) quadriliteral 'shaking'. Masdar root: ز-ل-ز-ل (z-l-z-l) — SAME ROOT. ✓ Valid maf'ul mutlaq. Pattern: Quadriliteral masdar فِعْلَالٌ (zilzāl).

**2. Verb: كَلَّمَ (kallama) 'spoke' (Form II). Maf'ul mutlaq: تَكْلِيمًا (taklīman) 'speaking'**

Verb root: ك-ل-م (k-l-m) 'speaking'. Masdar root: ك-ل-م (k-l-m) — SAME ROOT. ✓ Valid maf'ul mutlaq. Pattern: Form II masdar تَفْعِيلٌ (tafʿīl).

**3. Verb: نَصَرَ (naṣara) 'helped'. Proposed maf'ul: عَوْنًا (ʿawnan) 'help/aid'**

Verb root: ن-ص-ر (n-ṣ-r) 'helping'. Proposed masdar root: ع-و-ن (ʿ-w-n) 'help' — DIFFERENT ROOTS. ✗ NOT a valid maf'ul mutlaq (would be a direct object or synonym, but not the absolute object pattern).
