...
**Connection to previous learning:** In [L4.06 Emphasis](/learn/level-4/emphasis-affirmation), you learned grammatical tools for emphasis (inna, repetition, particles). Balagha extends beyond grammar into the realm of artistic choice: word selection, arrangement, omission, and figurative language that creates meaning beyond literal translation.

**Forward connection:** This lesson establishes the three-branch framework. [L4.17 Figures of Speech](/learn/level-4/figures-of-speech) applies these concepts to specific rhetorical devices (metaphor, simile, ellipsis). Then Level 5 dedicates multiple lessons to applied balagha analysis of complete surahs.
...
You'll practice this more in [L4.17](/learn/level-4/figures-of-speech) with specific figures of speech.
...
**Next steps:**
- [L4.17 Figures of Speech in the Quran](/learn/level-4/figures-of-speech) — Apply this framework to five specific rhetorical devices with detailed Quranic examples
