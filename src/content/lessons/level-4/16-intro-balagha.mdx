...
<ExerciseBox
  title="Exercise 1: Identify the Branch"
  instructions="For each rhetorical feature, identify which branch of balagha studies it: ilm al-ma'ani, ilm al-bayan, or ilm al-badi'."
>
...
<ExerciseBox
  title="Exercise 2: Analyze Al-Fatiha's Opening"
  instructions="Examine the opening verse of Al-Fatiha and identify balagha elements."
>
...
<ExerciseBox
  title="Exercise 3: Balagha vs Grammar"
  instructions="For each pair of sentences, identify which is the concern of grammar vs balagha."
>
...
<ExerciseBox
  title="Exercise 4: Ar-Rahman Repetition Analysis"
  instructions="Read Surah Ar-Rahman (Chapter 55) and analyze the repeated refrain using ilm al-badi' concepts."
>
