...
<ExerciseBox question="Exercise 1: Identify Negation Particles and Their Functions">
...
Particle: لَيْسَ (laysa) — acts like kāna. Sentence type: Nominal (negating state, not action). Subject: ٱلْبِرَّ (al-birra) 'righteousness' — اِسْمُ لَيْسَ (ismu laysa) in nominative (special form). Translation: 'Righteousness is not...'

</ExerciseBox>

<ExerciseBox question="Exercise 2: Convert Between Negation Types">
...
<ExerciseBox question="Exercise 3: Apply Decision Tree">
...
<ExerciseBox question="Exercise 4: Full Morphological Analysis">
...
Particle: لَا (lā) — present negation. Root: س-و-ي (being equal). Verb: يَسْتَوِي (yastawī) — Form VIII (اِسْتَفْعَلَ pattern), present, third person singular. Mood: Indicative (damma implied on weak final ي). Tense: Present/general. Translation: 'The blind and the seeing are not equal.'
