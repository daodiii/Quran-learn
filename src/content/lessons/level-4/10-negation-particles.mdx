...
**Connection to previous learning:** In [L3.04 Present Tense & Moods](/learn/level-3/present-tense), you learned the three moods (indicative, subjunctive, jussive). Now you'll see how negation particles trigger these moods — particularly how **لَمْ** (lam) forces jussive mood while negating the past.

**Forward connection:** This lesson prepares you for [L5.13 Rhetorical Questions & Negation](/learn/level-5/rhetorical-negation), where you'll explore how negation combines with interrogative particles to create powerful Quranic rhetoric.
...
**Next steps:** In [L4.11 Weak Verbs Introduction](/learn/level-4/weak-verbs-intro), you'll discover how verbs containing weak letters (و، ي، ء) behave irregularly — including how they interact with negation particles and mood changes. Understanding negation first makes weak verb patterns easier to grasp.
