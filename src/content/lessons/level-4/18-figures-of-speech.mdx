...
- **Balāgha** (بَلَاغَة) — eloquence: the art of saying things beautifully and with impact.
- **Simile** (tashbīh / تَشْبِيه) — an open comparison using "like" or "as".
- **Metaphor** (istiʿārah / اِسْتِعَارَة) — describing one thing as if it were another.
</Callout>
