...
**Forward connection:** This lesson completes the weak verb series. With all four categories mastered, you'll move to [L4.17 Introduction to Balagha](/learn/level-4/17-intro-balagha/) (rhetoric), expanding from morphology to stylistics and eloquence.
...
- **Hamzated verb** (mahmūz / مَهْمُوز) — a verb with a hamza (ء) as one of its root letters.
</Callout>
...
Press each person and watch the initial hamza's seat stay on the alif — only the suffix changes:

<ConjugationEngine
  roots={[
    { id: "amara", letters: "ء-م-ر", gloss: "to command", stem: "أَمَر", tr: "amar" }
  ]}
  persons={[
...
**Next steps:**
- [L4.17 Introduction to Balagha](/learn/level-4/17-intro-balagha/) — Move from morphology to rhetoric and eloquence
- [L4.18 Figures of Speech](/learn/level-4/18-figures-of-speech/) — Explore Quranic linguistic beauty
