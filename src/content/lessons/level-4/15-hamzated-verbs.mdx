...
**Connection to previous learning:** In [L4.11 Weak Verbs Introduction](/learn/level-4/weak-verbs-intro), you learned the four-category system. You've mastered [L4.12 Hollow Verbs](/learn/level-4/hollow-verbs) (middle weak), [L4.13 Defective Verbs](/learn/level-4/defective-verbs) (final weak), and [L4.14 Assimilated Verbs](/learn/level-4/assimilated-verbs) (initial weak). Hamzated verbs complete the system — they're different because hamza doesn't contract or drop like و/ي. Instead, its SPELLING changes while pronunciation stays the same.

**Forward connection:** This lesson completes the weak verb series. With all four categories mastered, you'll move to [L4.16 Introduction to Balagha](/learn/level-4/balagha-intro) (rhetoric), expanding from morphology to stylistics and eloquence.
...
**Next steps:**
- [L4.16 Introduction to Balagha](/learn/level-4/balagha-intro) — Move from morphology to rhetoric and eloquence
- [L4.17 Figures of Speech](/learn/level-4/figures-of-speech) — Explore Quranic linguistic beauty
