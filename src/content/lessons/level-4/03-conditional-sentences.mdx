...
You learned in [L3.04 Past & Present Tense](/learn/level-3/past-present-tense) that present tense verbs normally end in ḍamma (ـُ) for indicative mood. In conditional sentences with إِنْ, that changes to jussive mood with visible markers:
...
This structural foundation prepares you for [L4.04 Types of Conditional Particles](/learn/level-4/conditional-particles), where you'll learn how different particles (إِنْ, إِذَا, لَوْ) create different certainty levels and mood requirements.

## Related Lessons

**Prerequisites:**
- [L2.03 Verbal Sentences](/learn/level-2/verbal-sentences) — verbal sentence structure
- [L3.04 Past & Present Tense](/learn/level-3/past-present-tense) — verb moods (indicative established as baseline)

**Next steps:**
- [L4.04 Types of Conditional Particles](/learn/level-4/conditional-particles) — in vs idha vs law certainty scale
- [L4.10 Negation Particles](/learn/level-4/negation-particles) — similar particle-based mood changes

**Advanced application:**
- [L5.07 Complex Conditional Structures](/learn/level-5/complex-conditionals) — nested conditionals and multiple clauses
