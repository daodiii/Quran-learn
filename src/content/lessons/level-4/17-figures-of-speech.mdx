...
In [L4.16](/learn/level-4/intro-balagha), you learned the three-branch framework of [balagha](/resources/glossary#balaghah) (balāghah / بَلَاغَةٌ) — the science of eloquent expression. Now you'll apply that framework by studying FIVE specific figures of speech that appear frequently in the Quran.
...
**Connection to previous learning:** [L4.16](/learn/level-4/intro-balagha) taught you the three-branch framework (ma'ani, bayan, badi'). These five figures of speech are the TOOLS within those branches. Think of L4.16 as learning what a toolkit contains; L4.17 teaches you how to USE specific tools.
