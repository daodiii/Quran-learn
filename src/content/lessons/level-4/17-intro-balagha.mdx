...
**Forward connection:** This lesson establishes the three-branch framework. [L4.18 Figures of Speech](/learn/level-4/18-figures-of-speech/) applies these concepts to specific rhetorical devices (metaphor, simile, ellipsis). Then Level 5 dedicates multiple lessons to applied balagha analysis of complete surahs.
...
**Level 4 Balagha (L4.17-18):** INTRODUCTION
...
**Think of it this way:** L4.17-18 teach you the VOCABULARY of rhetoric (what is tashbih? what is hadhf?). Level 5 teaches you to SPEAK the language (analyze actual Quranic passages rhetorically).
...
You'll practice this more in [L4.18](/learn/level-4/18-figures-of-speech/) with specific figures of speech.
...
**Next steps:**
- [L4.18 Figures of Speech in the Quran](/learn/level-4/18-figures-of-speech/) — Apply this framework to five specific rhetorical devices with detailed Quranic examples
