...
**Connection to previous learning:** In [L3.16 Active & Passive Participles](/learn/level-3/16-active-passive-participles/), you learned how verbs become doer/receiver nouns. In [L3.17 Verbal Nouns (Masdar)](/learn/level-3/17-verbal-nouns/), you learned how verbs become action nouns. Now you'll see how verbs become LOCATION/TIME nouns — completing the full derived noun toolkit.
...
**Verb Forms System (L3.03-15):**
- Present tense conjugation (L3.03)
- Past vs. present tense (L3.04)
- Form II intensive/causative (L3.10)
- Form III reciprocal (L3.11)
- Form IV simple causative (L3.12)
- Form V reflexive of II (L3.13)
- Form VI mutual (L3.14)
- Forms VII-X overview (L3.15 — today's lesson)

**Verb Components (L3.05-09):**
- Imperative mood (L3.05)
- Independent pronouns (L3.06)
- Attached pronouns (L3.07)
- Demonstrative pronouns (L3.08)
- Relative pronouns (L3.09)

**Derived Nouns (L3.16-18):**
- Active & passive participles (L3.16) — WHO does/receives the action
- Verbal nouns/masdar (L3.17) — THE ACTION itself
- Nouns of place & time (L3.18 — this lesson) — WHERE/WHEN the action occurs
...
**Related Lessons:**
- Previous: [Verbal Nouns (Masdar)](/learn/level-3/17-verbal-nouns/) — "Abstract action nouns"
- Previous: [Active & Passive Participles](/learn/level-3/16-active-passive-participles/) — "Doer and receiver nouns"
