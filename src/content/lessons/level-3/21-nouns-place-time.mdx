...
- **Noun of place** (ism al-makān / اِسْم المَكَان) — a word for where something happens (e.g. "mosque" = place of prostration).
- **Noun of time** (ism az-zamān / اِسْم الزَّمَان) — a word for when something happens.
...
- **Verbal noun** (maṣdar / مَصْدَر) — the action turned into a noun: "writing", "help".
</Callout>
