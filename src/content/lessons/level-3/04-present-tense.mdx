...
**Forward connection:** This lesson prepares you for [L3.05 Imperative](/learn/level-3/imperative), where you'll learn how commands are derived directly from present tense by removing the prefix. It also prepares you for [L3.07 Subjunctive and Jussive Moods](/learn/level-3/subjunctive-jussive), where you'll discover that present tense has THREE mood forms, not just one.
...
**Prerequisites:**
- [L3.03 Past Tense Conjugation](/learn/level-3/past-tense) — Present tense builds on the past tense 14-person system
- [L3.02 Verb Form I](/learn/level-3/verb-form-i) — The يَفْعُلُ pattern is Form I present tense

**Next Steps:**
- [L3.05 Imperative](/learn/level-3/imperative) — Commands are derived directly from present tense
- [L3.06 Subject Pronouns](/learn/level-3/subject-pronouns) — Independent pronouns corresponding to conjugations
- [L3.07 Subjunctive and Jussive Moods](/learn/level-3/subjunctive-jussive) — The other two moods of present tense

**Advanced Topics:**
- [L3.10 Weak Verbs](/learn/level-3/weak-verbs) — Verbs with weak letters conjugate irregularly in present tense
- [L4.03 Active and Passive Participles](/learn/level-4/participles) — Participles often function with present tense meaning
- [L4.10 Conditional Sentences](/learn/level-4/conditional) — Present tense verbs in "if-then" structures

**Reference Resources:**
- [Verb Forms Chart](/resources/verb-forms-chart) — Present tense conjugations for all Forms I-X
