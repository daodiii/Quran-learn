...
In [L3.10 Verb Form II](/learn/level-3/10-verb-form-ii/), you learned how doubling the middle letter creates causative and intensive meanings. Now you'll discover another transformation: inserting a long vowel to create INTERACTIVE action — action directed toward someone or done WITH someone.
...
<ArabicExample
  ...
  highlight="كَرِهَ"
  words={[
    { ar: "يُرِيدُونَ", tr: "yurīdūna", en: "They want" },
    { ar: "أَن", tr: "an", en: "to" },
    { ar: "يُطْفِئُوا", tr: "yuṭfiʾū", en: "extinguish" },
    { ar: "نُورَ", tr: "nūra", en: "the light" },
    { ar: "ٱللَّهِ", tr: "llāhi", en: "of Allah" },
    { ar: "بِأَفْوَٰهِهِمْ", tr: "bi-afwāhihim", en: "with their mouths" },
    { ar: "وَيَأْبَى", tr: "wa-yaʾbā", en: "but refuses" },
    { ar: "ٱللَّهُ", tr: "llāhu", en: "Allah" },
    { ar: "إِلَّآ", tr: "illā", en: "except" },
    { ar: "أَن", tr: "an", en: "to" },
    { ar: "يُتِمَّ", tr: "yutimma", en: "perfect" },
    { ar: "نُورَهُۥ", tr: "nūrahu", en: "His light" },
    { ar: "وَلَوْ", tr: "wa-law", en: "although" },
    { ar: "كَرِهَ", tr: "kariha", en: "dislike" },
...
**Connection to previous learning:** Like [Form II](/learn/level-3/10-verb-form-ii/), Form III modifies the base [Form I](/learn/level-3/02-verb-form-i/) pattern. But instead of doubling the middle letter, Form III STRETCHES the verb by inserting a long vowel (ā) after the first root letter. This creates interactive meaning.

**Forward connection:** Form III is the foundation for [Form VI](/learn/level-3/14-verb-form-vi/), which adds تَ prefix to Form III for reflexive/reciprocal meaning (تَفَاعَلَ). Understanding Form III's "interactive" nature now prepares you for the entire family of reciprocal verb forms.
...
- [L3.10 Verb Form II](/learn/level-3/10-verb-form-ii/) — Doubled-middle pattern
- [L3.14 Verb Form VI](/learn/level-3/14-verb-form-vi/) — Reflexive of Form III (تَفَاعَلَ)
...
- [L3.10: Verb Form II](/learn/level-3/10-verb-form-ii/) — Doubled-middle pattern for comparison
- [L3.12: Verb Form IV](/learn/level-3/12-verb-form-iv/) — Another derived form pattern
- [L3.14: Verb Form VI](/learn/level-3/14-verb-form-vi/) — Reflexive of Form III (تَفَاعَلَ)
- [L3.15: Verb Forms VII-X Overview](/learn/level-3/15-verb-forms-vii-x/) — Complete derived forms
- [L3.16: Active & Passive Participles](/learn/level-3/16-active-passive-participles/) — Deriving nouns from Form III
