...
<GrammarTable
  ...
  headers={["Root", "Form II", "Meaning", "Form V", "Meaning"]}
  rows={[
    ["ع-م-ي", "عَمَّى", "he blinded (made blind)", "تَعَامَىٰ", "he feigned blindness"],
    ...
    ["ج-ه-ل", "جَهَّلَ", "he made ignorant", "تَجَاهَلَ", "he feigned ignorance"]
  ]}
/>
...
3. **Pretending** — act AS IF having the quality (less common)
   - عَمَّىٰ "he blinded" → تَعَامَىٰ "he feigned blindness"
