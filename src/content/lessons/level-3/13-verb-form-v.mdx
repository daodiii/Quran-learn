...
**Connection to previous learning:** Form V builds directly on [Form II](/learn/level-3/verb-form-ii). Remember Form II's doubled middle letter? Form V simply adds **تَ prefix** to that pattern: فَعَّلَ → تَفَعَّلَ. The تَ makes the Form II causative action turn inward on the subject.

**Forward connection:** Form V is paired with [Form VI](/learn/level-3/verb-form-vi), which follows the exact same logic: تَ prefix + Form III = Form VI. Once you understand Form V, you'll see the systematic pattern that runs through the entire derived verb system.
...
**Related lessons:**
- [L3.10 Verb Form II](/learn/level-3/verb-form-ii) — Parent form of Form V
- [L3.14 Verb Form VI](/learn/level-3/verb-form-vi) — Parallel pattern (تَ + Form III)
