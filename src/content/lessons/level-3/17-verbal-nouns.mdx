...
**Connection to previous learning:** In [L3.16 Active & Passive Participles](/learn/level-3/16-active-passive-participles/), you learned how verbs become PERSON nouns (doer and receiver). Now you'll see how verbs become ACTION nouns. Together, participles and masdars give you the full derived-noun system in Arabic.

**Forward connection:** This lesson prepares you for [L3.18 Nouns of Place & Time](/learn/level-3/18-nouns-place-time/), which completes the derived noun series. After these three lessons (L3.16-18), you'll understand how Arabic derives rich vocabularies from verb roots through systematic patterns.
...
| **تَفْعِيلٌ** (tafʿīlun) | ح-م-د | حَمِدَ (ḥamida) "praised" | حَمْدٌ (ḥamdun) | praise |
</GrammarTable>
...
<Callout type="insight" title="Masdars can become concrete nouns">
...
<ExerciseBox
  title="Exercise 1: Identify Masdars"
  instructions="Which of these words are masdars (verbal nouns)? For each masdar, identify the root and form."
  questions={[
    {
      prompt: "حَمْدٌ (ḥamdun) — praise",
      answer: "Masdar. Root: ح-م-د (praising). Form I masdar, pattern فَعْلٌ (faʿlun). Meaning: the act of praising."
    },
    {
      prompt: "حَامِدٌ (ḥāmidun) — praiser",
      answer: "NOT a masdar — this is an active participle (pattern فَاعِلٌ). Root: ح-م-د. It describes the DOER, not the action itself."
    },
    {
      prompt: "تَعْلِيمٌ (taʿlīmun) — teaching",
      answer: "Masdar. Root: ع-ل-م (knowing). Form II masdar, pattern تَفْعِيلٌ (tafʿīlun). Meaning: the act of teaching."
    },
    {
      prompt: "مَعْلُومٌ (maʿlūmun) — known",
      answer: "NOT a masdar — this is a passive participle (pattern مَفْعُولٌ). Root: ع-ل-م. It describes what is KNOWN, not the act of knowing."
    }
  ]}
/>

<ExerciseBox
  title="Exercise 2: Derive Form II-X Masdars"
  instructions="Given the verb, derive the masdar using the appropriate form pattern."
  questions={[
    {
      prompt: "Root: ع-ل-م. Form II verb: عَلَّمَ (ʿallama) 'he taught'. Derive the masdar.",
      answer: "Form II masdar pattern: تَفْعِيلٌ (tafʿīlun). Apply to root ع-ل-م → تَعْلِيمٌ (taʿlīmun) 'teaching, instruction'."
    },
    {
      prompt: "Root: غ-ف-ر. Form X verb: اِسْتَغْفَرَ (istaghfara) 'he sought forgiveness'. Derive the masdar.",
      answer: "Form X masdar pattern: اِسْتِفْعَالٌ (istifʿālun). Apply to root غ-ف-ر → اِسْتِغْفَارٌ (istighfārun) 'seeking forgiveness'."
    },
    {
      prompt: "Root: س-ل-م. Form IV verb: أَسْلَمَ (aslama) 'he submitted'. Derive the masdar.",
      answer: "Form IV masdar pattern: إِفْعَالٌ (ifʿālun). Apply to root س-ل-م → إِسْلَامٌ (islāmun) 'submission, Islam'."
    }
  ]}
/>

<ExerciseBox
  title="Exercise 3: Masdars in Al-Fatiha"
  instructions="Analyze each verb in Al-Fatiha and state its masdar."
  questions={[
    {
      prompt: "نَعْبُدُ (naʿbudu) — 'we worship' [Al-Fatiha 1:5]. What is the masdar?",
      answer: "Root: ع-ب-د. Form I verb. Masdar: عِبَادَةٌ (ʿibādatun) 'worship, service'. Pattern: فِعَالَةٌ (fiʿālatun)."
    },
    {
      prompt: "نَسْتَعِينُ (nastaʿīnu) — 'we ask for help' [Al-Fatiha 1:5]. What is the masdar?",
      answer: "Root: ع-و-ن. Form X verb (اِسْتَفْعَلَ). Masdar: اِسْتِعَانَةٌ (istiʿānatun) 'seeking help'. Pattern: اِسْتِفْعَالٌ (istifʿālun)."
    },
    {
      prompt: "ٱهْدِنَا (ihdinā) — 'guide us' [Al-Fatiha 1:6]. What is the masdar?",
      answer: "Root: ه-د-ي. Form I verb (defective). Masdar: هِدَايَةٌ (hidāyatun) 'guidance'. Pattern: fiʿālatun."
    }
  ]}
/>
...
<ExerciseBox
  ...
  instructions="For the given root, list all derived forms in sequence: Form I verb, active participle, passive participle, and masdar."
  questions={[
    {
      prompt: "Root: ع-ب-د (worshiping/serving). Complete the derivation chain.",
      answer: "Form I verb: عَبَدَ (ʿabada) 'he worshiped'. Active participle: عَابِدٌ (ʿābidun) 'worshiper'. Passive participle: مَعْبُودٌ (maʿbūdun) 'worshiped one, deity'. Masdar: عِبَادَةٌ (ʿibādatun) 'worship'."
    },
    {
      prompt: "Root: ش-ك-ر (thanking). Complete the derivation chain.",
      answer: "Form I verb: شَكَرَ (shakara) 'he thanked'. Active participle: شَاكِرٌ (shākirun) 'thankful one'. Passive participle: مَشْكُورٌ (mashkūrun) 'thanked one'. Masdar: شُكْرٌ (shukrun) 'thanks, gratitude' (pattern فُعْلٌ)."
    },
    {
      prompt: "Root: ذ-ك-ر (remembering). Complete the derivation chain.",
      answer: "Form I verb: ذَكَرَ (dhakara) 'he remembered'. Active participle: ذَاكِرٌ (dhākirun) 'one who remembers'. Passive participle: مَذْكُورٌ (madhkūrun) 'remembered, mentioned'. Masdar: ذِكْرٌ (dhikrun) 'remembrance' (pattern فِعْلٌ)."
    }
  ]}
/>
