...
**Connection to previous learning:** In [L3.16 Active & Passive Participles](/learn/level-3/active-passive-participles), you learned how verbs become PERSON nouns (doer and receiver). Now you'll see how verbs become ACTION nouns. Together, participles and masdars give you the full derived-noun system in Arabic.

**Forward connection:** This lesson prepares you for [L3.18 Nouns of Place & Time](/learn/level-3/nouns-place-time), which completes the derived noun series. After these three lessons (L3.16-18), you'll understand how Arabic derives rich vocabularies from verb roots through systematic patterns.
