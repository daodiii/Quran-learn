...
- **Pattern / measure** (wazn / وَزْن) — the mould of vowels and extra letters poured over a root to make a specific word.
...
**Topic Hub:**
- [Arabic Verb Forms (I–X)](/learn/verb-forms/) — Form VI in context with all ten forms and a learning path
