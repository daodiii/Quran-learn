...
**Connection to previous learning:** Form V builds directly on [Form II](/learn/level-3/12-verb-form-ii/). Remember Form II's doubled middle letter? Form V simply adds **تَ prefix** to that pattern: فَعَّلَ → تَفَعَّلَ. The تَ makes the Form II causative action turn inward on the subject.

**Forward connection:** Form V is paired with [Form VI](/learn/level-3/16-verb-form-vi/), which follows the exact same logic: تَ prefix + Form III = Form VI. Once you understand Form V, you'll see the systematic pattern that runs through the entire derived verb system.
...
We'll show 8 representative persons to illustrate the pattern. Press each person and watch the تَ prefix and doubled ل stay put — only the suffix changes:

<ConjugationEngine
  roots={[
    { id: "taallama", letters: "ع-ل-م", gloss: "to learn", stem: "تَعَلَّم", tr: "taʿallam" }
  ]}
  persons={[
...
**Related lessons:**
- [L3.12 Verb Form II](/learn/level-3/12-verb-form-ii/) — Parent form of Form V
- [L3.16 Verb Form VI](/learn/level-3/16-verb-form-vi/) — Parallel pattern (تَ + Form III)
...
**Topic Hub:**
- [Arabic Verb Forms (I–X)](/learn/verb-forms/) — Form V in context with all ten forms and a learning path
