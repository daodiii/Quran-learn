...
- [L4.05 Complex Sentences](/learn/level-4/03-conditional-sentences) — Advanced relative clause usage

**Advanced Topics:**
- [L4.06 Relative Clause Variations](/learn/level-3/09-relative-pronouns) — Advanced ṣilah structures
- [L5.04 Embedded Clauses](/learn/level-5/15-nahw-synthesis) — Multiple relative pronouns and nested structures
