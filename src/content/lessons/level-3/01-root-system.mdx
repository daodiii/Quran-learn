...
**Connection to previous learning:** In [L1.04 Three Word Types](/learn/level-1/04-three-word-types/), you learned that Arabic has nouns, verbs, and particles. Now you'll discover that nouns and verbs are built from the same building blocks — roots and patterns. This is Arabic morphology (ṣarf / صَرْفٌ), the science of how words are formed.
...
The root system is the master key to Arabic vocabulary. From a single root like ح-م-د (h-m-d) come حَمْدٌ (praise), مُحَمَّدٌ (Muhammad), أَحْمَدُ (Ahmad), حَامِدٌ (one who praises), and مَحْمُودٌ (praised). Once you recognize a root, you unlock an entire family of related Quranic words.
</Callout>

<Callout type="note" title="Quick Win">
You already know the root ك-ت-ب (k-t-b) "writing" from ٱلْكِتَابُ ("the Book"). Now recognize كَاتِبٌ ("writer"), مَكْتُوبٌ ("written"), and كُتُبٌ ("books") — all from the same three letters. You just expanded your vocabulary fourfold.
</Callout>
...
- **Ṣarf** (صَرْف) — word-building: how Arabic grows many words out of one root.
...
<ArabicExample
  arabic="ذَٰلِكَ ٱلْكِتَابُ لَا رَيْبَ فِيهِ هُدًى لِّلْمُتَّقِينَ"
...
<ArabicExample
  ...
  words={[
    ...
    { ar: "ٱلَّذِينَ", tr: "lladhīna", en: "who" },
...
<ArabicExample
  ...
  words={[
    ...
    { ar: "ٱلْأَسْمَآءَ", tr: "l-asmāʾa", en: "the names" },
...
<ArabicExample
  ...
  words={[
    ...
    { ar: "بِكُلِّ", tr: "bi-kulli", en: "of all/every" },
    { ar: "شَىْءٍ", tr: "shayʾin", en: "thing" },
    { ar: "عَلِيمٌ", tr: "ʿalīmun", en: "Knowing" }
  ]}
/>
...
<ExerciseBox question="Exercise 5 — Root Detective: Extract the trilateral root from each of these Quranic words: (1) نَاصِرٌ (nāṣirun), (2) مَغْفِرَةٌ (maghfiratun), (3) رَحِيمٌ (raḥīmun), (4) يَعْبُدُونَ (yaʿbudūna), (5) مُنْزَلٌ (munzalun)">

**Answers:**

1. **نَاصِرٌ** (nāṣirun) — "helper"
   - Pattern: فَاعِلٌ (fāʿil) — active participle. Remove long ā (pattern vowel) and case ending.
   - Root: **ن-ص-ر** (n-ṣ-r) — "help, victory"

2. **مَغْفِرَةٌ** (maghfiratun) — "forgiveness"
...
<ExerciseBox question="Exercise 6 — Meaning Prediction: The root ف-ت-ح (f-t-ḥ) carries the core meaning of 'opening.' Using this knowledge, predict the meaning of each derived word: (1) فَتَحَ (fataḥa), (2) فَاتِحَةٌ (fātiḥatun), (3) مِفْتَاحٌ (miftāḥun), (4) فَتَّاحٌ (fattāḥun)">

**Answers:**

1. **فَتَحَ** (fataḥa) — Pattern: فَعَلَ (faʿala) — Form I past tense
...
2. **فَاتِحَةٌ** (fātiḥatun) — Pattern: فَاعِلَة (fāʿilah) — active participle (feminine)
...
3. **مِفْتَاحٌ** (miftāḥun) — Pattern: مِفْعَالٌ (mifʿāl) — instrument noun
...
4. **فَتَّاحٌ** (fattāḥun) — Pattern: فَعَّالٌ (faʿʿāl) — intensive/habitual doer
...
<ExerciseBox question="Exercise 7 — Verse Discovery: Read this verse from Al-Baqarah 2:282 — كَاتِبٌ بِٱلْعَدْلِ (kātibun bi-l-ʿadli) 'a scribe with justice.' Identify the root of every content word, then group the words by root family.">

**Answer:**

**Word-by-word root identification:**

1. **كَاتِبٌ** (kātibun) — "scribe/writer"
...
3. **ٱلْعَدْلِ** (al-ʿadli) — "the justice"
...
**Prerequisites:**
- [L1.04: Three Word Types](/learn/level-1/04-three-word-types/) — Understanding nouns, verbs, and particles
...
- [L3.12: Verb Form II](/learn/level-3/12-verb-form-ii/) — How doubling a root letter changes meaning
- [L3.19: Active and Passive Participles](/learn/level-3/19-active-passive-participles/) — Deriving nouns from verb roots
- [L3.20: Verbal Nouns](/learn/level-3/20-verbal-nouns/) — Maṣdar forms and their patterns

**Topic Hub:**
- [Arabic Verb Forms (I–X)](/learn/verb-forms/) — Pedagogical overview of all ten forms, signature features, and learning path
