...
**Connection to previous learning:** In [L1.06 Three Word Types](/learn/level-1/three-word-types), you learned that Arabic has nouns, verbs, and particles. Now you'll discover that nouns and verbs are built from the same building blocks — roots and patterns. This is Arabic morphology (ṣarf / صَرْفٌ), the science of how words are formed.
...
**Prerequisites:**
- [L1.06: Three Word Types](/learn/level-1/three-word-types) — Understanding nouns, verbs, and particles
- [L2.03: Verbal Sentence](/learn/level-2/verbal-sentence) — Verb structure and function

**Build on this lesson:**
- [L3.02: Verb Form I](/learn/level-3/verb-form-i) — How roots become verbs using the simplest pattern
- [L3.10: Verb Form II](/learn/level-3/verb-form-ii) — How doubling a root letter changes meaning
- [L3.04: Active and Passive Participles](/learn/level-3/active-passive-participles) — Deriving nouns from verb roots
- [L3.05: Verbal Nouns](/learn/level-3/verbal-nouns) — Maṣdar forms and their patterns

**Resources:**
- [Root System Guide](/resources/root-system-guide) — Complete reference for root extraction and dictionary use
- [200 Most Common Quranic Words](/resources/common-words) — Practice root identification with frequently used words
