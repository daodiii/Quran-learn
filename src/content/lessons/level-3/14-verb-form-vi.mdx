...
You just learned [Form V](/learn/level-3/verb-form-v) — how adding تَ prefix to Form II creates reflexive meaning. Now you'll discover the SAME pattern applied to [Form III](/learn/level-3/verb-form-iii): **تَ prefix + Form III = Form VI**. It's beautifully systematic.
...
**Connection to previous learning:** Form VI follows the EXACT same logic as [Form V](/learn/level-3/verb-form-v). Just as Form V adds تَ to [Form II](/learn/level-3/verb-form-ii), Form VI adds تَ to [Form III](/learn/level-3/verb-form-iii). If you understand Form V → Form VI is automatic.

**The pattern:**
- Form II (فَعَّلَ) + تَ = Form V (تَفَعَّلَ) — reflexive of causative
- Form III (فَاعَلَ) + تَ = Form VI (تَفَاعَلَ) — reflexive of interactive

**Forward connection:** After mastering Forms V and VI, you'll see that the Arabic verb system is SYSTEMATIC, not random. The تَ prefix consistently creates reflexive/reciprocal meaning across multiple derived forms. This prepares you for [Forms VII-X](/learn/level-3/verb-forms-vii-x).
...
**Note:** Full conjugation (all 14 persons including dual) follows the same pattern. See [L3.03](/learn/level-3/past-tense) and [L3.04](/learn/level-3/present-tense) for complete suffix systems.
...
**Related lessons:**
- [L3.11 Verb Form III](/learn/level-3/verb-form-iii) — Parent form of Form VI
- [L3.13 Verb Form V](/learn/level-3/verb-form-v) — Parallel pattern (تَ + Form II)
...
- [L3.13: Verb Form V](/learn/level-3/verb-form-v) — Parallel pattern (تَ + Form II)
- [L3.15: Verb Forms VII-X Overview](/learn/level-3/verb-forms-vii-x) — Complete derived forms system
