...
<Callout type="tip" title="Suffix Cheat Sheet — The 5 High-Frequency Patterns">

| Pattern | Who | Memory Hook |
|---------|-----|-------------|
| تَ / ta | you (m.) | "ta = talking to a man" |
| تِ / ti | you (f.) | "ti = talking to a woman" |
| تُ / tu | I | "tu = I did it (the speaker)" |
| نَا / nā | we | "nā = 'nah, we did it'" |
| وا / ū | they | "ū = oooh, a crowd" |

These cover the majority of Quranic occurrences. The full 14-form paradigm above includes dual and feminine-plural forms you will encounter less frequently.

Master Rule: The هُوَ (he) form takes only a final fatha (ـَ) — the simplest suffix of all.
...
<ExerciseBox question="Suffix Identification Drill" id="suffix-id-drill">

Identify the suffix and the speaker for each verb:
...
| Verb | Suffix | Speaker |
|------|--------|---------|
| كَتَبْتَ | ta (تَ) | you (m.) |
| كَتَبْتِ | ti (تِ) | you (f.) |
| كَتَبْتُ | tu (تُ) | I |
| كَتَبْنَا | nā (نَا) | we |
| كَتَبُوا | ū (وا) | they |
...
<ExerciseBox question="Build It — Conjugate ن-ز-ل in Past Tense" id="build-it-nazala">

Using root ن-ز-ل (to descend), conjugate past tense for:
...
<ExerciseBox question="Quranic Treasure Hunt: Find 3 Past-Tense Verbs in Al-Baqarah 2:1–10" id="quran-treasure-hunt">

Open Al-Baqarah (2:1–10) and find 3 past-tense verbs. For each, identify the root and who performed the action.

**Hints — three verbs to look for:**

| Verb | Root | Who |
|------|------|-----|
| خَتَمَ | خ-ت-م (to seal) | Allah (3rd m. sg.) |
| جَعَلَ | ج-ع-ل (to make/place) | Allah (3rd m. sg.) |
| كَفَرَ | ك-ف-ر (to disbelieve) | they (plural) |
