...
**Forward connection:** This lesson prepares you for [L3.04 Present Tense Conjugation](/learn/level-3/04-present-tense/), where you'll learn how present tense uses PREFIXES as well as suffixes. It also prepares you for [L3.06 Subject Pronouns](/learn/level-3/06-subject-pronouns/), where you'll study the independent pronouns (أَنَا, أَنْتَ, هُوَ) that correspond to these conjugations.
...
- [L3.06 Subject Pronouns](/learn/level-3/06-subject-pronouns/) — Study the independent pronouns that correspond to these conjugations
- [L3.05 Imperative](/learn/level-3/05-imperative/) — Commands are derived from present tense but follow similar suffix patterns

**Advanced Topics:**
- [L3.10 Weak Verbs](/learn/level-4/11-weak-verbs-intro/) — Verbs with weak letters (و, ي, ء) conjugate irregularly
- [L4.11 Verbal Noun Usage](/learn/level-3/17-verbal-nouns/) — The [verbal noun](/resources/glossary/#masdar) (maṣdar / مَصْدَر) relates to past tense meaning
