...
| تُ / tu | I | "tu = tu parles? No — you did it!" |
| نَا / nā | we | "nā = 'nah, we did it'" |
| وا / ū | they | "ū = oooh, a crowd" |

Master Rule: The هُوَ (he) form has no suffix at all — it's the naked stem. Every other pattern is an add-on.
...
<ExerciseBox title="Suffix Identification Drill" type="practice">

What suffix is being used? Who is the speaker?
...
<ExerciseBox title="Build It" type="practice">
...
<ExerciseBox title="Quranic Treasure Hunt" type="challenge">
...
| وَعَدَ | و-ع-د (to promise) | — find it yourself! |
