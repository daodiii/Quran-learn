...
verseCount: 3
difficulty: "beginner"
description: "Grammatical breakdown of Surah Al-Kawthar — Allah's abundant blessings to the Prophet ﷺ, including the river of Paradise, with the command to pray and sacrifice. Covers inna + pronoun (inna), past-tense first-person plural verbs, imperative mood, and inna nominal sentences."
---
...
<ArabicExample
  ...
  words={[
    ...
    { ar: "أَعْطَيْنَاكَ", tr: "aʿṭaynāka", en: "We gave you, granted you" },
    { ar: "الْكَوْثَرَ", tr: "al-kawthar", en: "Al-Kawthar, abundance" }
  ]}
/>
...
<ArabicExample
  ...
  words={[
    ...
    { ar: "وَانْحَرْ", tr: "wa-nḥar", en: "And sacrifice" }
  ]}
/>
...
<ArabicExample
  ...
  words={[
    ...
    { ar: "شَانِئَكَ", tr: "shāni'aka", en: "Your hater, enemy" },
    { ar: "هُوَ", tr: "huwa", en: "He (emphatic)" },
    { ar: "الْأَبْتَرُ", tr: "al-abtar", en: "The cut off, the one without legacy" }
  ]}
/>
